    ...
    for entry in pack.plugins:
        ...
        try:
            if index_entries is None:
                from thefool_cli.plugin_index import load_index

                index_entries, _src = load_index()
            from thefool_cli.plugin_index import resolve_name
...
def install_pack_plugins(
    ...
    *,
    ...
    single install (:func:`thefool_cli.plugins_cmd._run_capability_consent`).
