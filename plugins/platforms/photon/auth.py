...
def _save_auth(data: Dict[str, Any]) -> None:
    ...
    # fool_cli/auth.py:_save_auth_store (#19673, #21148).
    fd = os.open(
        str(tmp),
...
def store_photon_token(token: str) -> None:
    ...
    from fool_cli.auth import _auth_store_lock
...
def _persist_runtime_env(spectrum_project_id: str, project_secret: str) -> None:
    ...
    try:
        ...
        logger.warning("photon: fool_cli.config unavailable — skipping .env write")
        return
    try:
