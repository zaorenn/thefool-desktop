...
export const en: Translations = {
  ...
  boot: {
    ready: 'The Fool Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading The Fool settings',
    ...
    errors: {
      ...
      backgroundExitedDuringStartup: 'The Fool background process exited during startup.',
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting The Fool Desktop.',
    ...
    native: {
      ...
      inputBody: 'The Fool is waiting for your response.',
      turnDoneTitle: 'The Fool finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to The Fool defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Run in the Fool backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Fool backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while The Fool is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'The Fool asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while The Fool was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while The Fool was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let The Fool follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and The Fool can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what The Fool is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen The Fool, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'The Fool checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading The Fool configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening The Fool.',
    ...
    connections: {
      title: 'Connections',
      intro:
        'Register every place your agents live — this device, remote gateways on your network, and The Fool Cloud instances. All of them are stored here.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by The Fool Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'The Fool Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Fool runtime managed by this app.',
      kindRemoteDesc: 'A Fool gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Fool Cloud account.',
      kindSshDesc: 'A Fool install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers The Fool manages (Authorization, Cookie, Host…) are ignored.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Fool backend elsewhere. Per-profile overrides below.',
      ...
      remoteDesc: 'Connect this desktop shell to a remote Fool backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'The Fool Cloud',
      cloudDesc: 'Sign in once to The Fool Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'The Fool Cloud',
      cloudSignIn: 'Sign in to The Fool Cloud',
      cloudSignedIn: 'Signed in to The Fool Cloud',
      cloudNeedsSignIn: 'Sign in to The Fool Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Fool Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'The Fool Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of The Fool Cloud',
      cloudSignedOutMessage: 'Cleared the Fool Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /fool.',
      ...
      restartingMessage: 'The Fool Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · The Fool ${version}` : ''}`,
      ...
      sshDesc:
        'The Fool is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — The Fool found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — The Fool runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'The Fool is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Fool path.',
      sshErrPlatform:
        'Unsupported remote platform. The Fool Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update The Fool on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to The Fool. Review the exact configuration below — it comes from the link, not from The Fool.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. The Fool runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point The Fool at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via fool curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As The Fool builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart The Fool to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update The Fool to generate pets.',
      backgroundHint: 'You can close this — The Fool will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure The Fool desktop' },
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@fool:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent The Fool environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'The Fool did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. The Fool will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Fool backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from The Fool. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Fool backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting The Fool...',
    placeholderReconnecting: 'Reconnecting to The Fool…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give The Fool a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'The Fool will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask The Fool to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating The Fool…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting The Fool…',
    ...
    unsupportedMessage: 'This version of The Fool can’t update itself from inside the app.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Fool desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Fool updater takes over in its own window and reopens The Fool automatically when it’s done. Please don’t reopen The Fool yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. The Fool reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then The Fool reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update The Fool?',
    blockerBody:
      'The Fool needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update The Fool',
    foreignBlockerBody:
      'The Fool can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'The Fool can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'The Fool needs a one-time install',
    ...
    setupChoiceTitle: 'Set up The Fool Desktop',
    setupChoiceDesc:
      'Connect this app to a Fool gateway you already run, or install The Fool locally on this computer.',
    connectExistingTitle: 'Connect to existing The Fool',
    ...
    installLocalTitle: 'Install The Fool locally',
    ...
    probeError: 'Could not reach that The Fool gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Fool Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another The Fool CLI or desktop instance is running. Stop any running The Fool instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Fool Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'The Fool is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting The Fool…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run The Fool',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — The Fool connects automatically',
    ...
    authorizeThere: 'Authorize The Fool there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize The Fool there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `The Fool Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `The Fool Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. The Fool will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'The Fool is restarting...',
      askRestart: 'Ask The Fool to restart the server',
      lookingRestart: taskId => `The Fool is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'The Fool is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `The Fool finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'The Fool could not restart the server.',
      stillWorking:
        'The Fool is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'The Fool is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'The Fool gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.fool/config.yaml). The Fool won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'The Fool needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'The Fool needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart The Fool Desktop to use Save Image.',
    restartToSaveImages: 'Restart The Fool Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `fool gateway` running?'
    }
  },
