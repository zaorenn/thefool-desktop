...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update The Fool plugins (`fool plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.fool/plugins/?",
    removeHint: "Only user-installed plugins under ~/.fool/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.fool/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that The Fool doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible The Fool badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning The Fool session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run The Fool more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once The Fool sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "The Fool is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
