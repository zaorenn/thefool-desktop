...
def enrolled_profile_phrases() -> Dict[str, str]:
    ...
    try:
        ...
        from fool_cli.profiles import get_profile_dir, list_profiles
...
# FOOL_HOME. Keywords are typed phrases tokenized at RUNTIME — no
...
# ---------------------------------------------------------------------------
# Process-wide singleton (mirrors fool_cli.voice's continuous API)
# ---------------------------------------------------------------------------
