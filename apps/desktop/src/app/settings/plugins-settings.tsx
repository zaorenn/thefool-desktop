...
// User-installed plugins first, bundled last — mirrors `fool plugins list`.
...
// to `fool dashboard`; model-providers/* are configured in Settings →
...
// Agent plugins live under the BACKEND's fool home (profile-aware), so the
// path comes from the gateway — not from the renderer's local FOOL_HOME.
