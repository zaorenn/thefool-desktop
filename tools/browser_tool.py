...
from fool_cli.config import DEFAULT_CONFIG, cfg_get
...
# comparison sites (four here, plus fool_cli/tools_config.py and
# fool_cli/doctor.py) from drifting if the sentinel's exact spelling ever
# changes.
