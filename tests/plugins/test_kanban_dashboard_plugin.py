...
def test_ws_events_rejects_when_token_required(tmp_path, monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "fool_cli.web_server", stub)
    monkeypatch.setattr(fool_cli, "web_server", stub, raising=False)
...
# tests/fool_cli/test_kanban_db.py. The OUTER fallback here is not, which
