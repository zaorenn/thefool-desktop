"""Tests for thefool_cli.copilot_auth — Copilot token validation and resolution."""
...
class TestResolveToken:
    ...
    def test_gh_cli_classic_pat_raises(self, monkeypatch):
        ...
        with patch("thefool_cli.copilot_auth._try_gh_cli_token", return_value="ghp_classic"):
