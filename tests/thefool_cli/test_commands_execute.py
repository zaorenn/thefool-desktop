...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`thefool_cli.slash_exec.EXECUTORS`, and
...
from thefool_cli.commands import COMMAND_REGISTRY, resolve_command
from thefool_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
