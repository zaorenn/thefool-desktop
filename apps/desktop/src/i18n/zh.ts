...
export const zh: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: '正在启动 The Fool 桌面版…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshHermesPathTitle: 'The Fool 路径（可选）',
      sshHermesPathDesc: '远程 fool 可执行文件的完整路径。留空 = 自动检测。',
  ...
  commandCenter: {
    ...
    hermesActiveSessions: (version, count) => `The Fool ${version} · 活跃会话 ${count}`,
    restartGateway: '重启网关',
