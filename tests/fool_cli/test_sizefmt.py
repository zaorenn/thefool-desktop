"""Tests for the shared byte formatter (fool_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from fool_cli.backup import _format_size as backup
    from fool_cli.checkpoints import _fmt_bytes as checkpoints
    from fool_cli.doctor import _human_bytes as doctor
