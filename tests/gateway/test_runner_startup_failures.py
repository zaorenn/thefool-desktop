...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("fool_logging.setup_logging", lambda hermes_home, mode: tmp_path)
    monkeypatch.setattr("fool_logging._add_rotating_handler", lambda *args, **kwargs: None)
