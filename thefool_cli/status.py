...
from thefool_cli.auth import AuthError, resolve_provider
from thefool_cli.colors import Colors, color
from thefool_cli.config import get_env_path, get_env_value, get_hermes_home, load_config
from thefool_cli.models import provider_label
from thefool_cli.nous_account import (
    format_nous_portal_entitlement_message,
    get_nous_portal_account_info,
)
from thefool_cli.nous_subscription import get_nous_subscription_features
from thefool_cli.runtime_provider import resolve_requested_provider
...
def _estop_status_line():
    ...
    Cheap: a single stat on $THEFOOL_HOME/ESTOP via agent.estop.
    """
    try:
...
def show_status(args):
    ...
    if _effective_provider_label() == "LM Studio":
        from thefool_cli.models import probe_lmstudio_models
        model_cfg = config.get("model")
    ...
    try:
        from thefool_cli.gateway import get_gateway_runtime_snapshot, _format_gateway_pids
    ...
    try:
        from thefool_cli.active_sessions import (
