...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The Fool agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the Fool agent, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the Fool agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the Fool agent, and all of your config, chats, secrets, and logs',
...
export function UninstallSection() {
  ...
  useEffect(() => {
    let alive = true
    const bridge = window.foolDesktop?.uninstall
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Uninstall The Fool</p>
