...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingFoolDesktop: '正在啟動 The Fool Desktop…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshFoolPathTitle: 'The Fool 路徑（選用）',
      sshFoolPathDesc: '遠端 fool 執行檔的完整路徑。留空 = 自動偵測。',
      sshFoolPathPlaceholder: '自動偵測',
  ...
  commandCenter: {
    ...
    foolActiveSessions: (version, count) => `The Fool ${version} · 活躍工作階段 ${count}`,
