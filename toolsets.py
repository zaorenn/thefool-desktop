...
_HERMES_CORE_TOOLS = [
    ...
    # spawned as a kanban worker (THEFOOL_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "kanban": {
        "description": (
            ...
            "is spawned by the kanban dispatcher (THEFOOL_KANBAN_TASK env "
    ...
    "coding": {
        ...
        # non-configurable-toolset recovery loop in thefool_cli/tools_config.py).
        "posture": True,
    },
