"""Tests for fool_cli.profile_distribution — git-based profile installs.
...
# ---------------------------------------------------------------------------
# Isolated profile env (matches tests/fool_cli/test_profiles.py)
# ---------------------------------------------------------------------------
...
class TestInstall:
    ...
    def test_update_respects_distribution_owned_allowlist(self, profile_env):
        ...
        from fool_cli.profile_distribution import read_manifest as _read
    ...
    def test_install_enforces_hermes_requires(self, profile_env, monkeypatch):
        ...
        import fool_cli
        monkeypatch.setattr(fool_cli, "__version__", "0.1.0", raising=False)
...
class TestInstalledAtStamp:
    ...
    def test_update_refreshes_installed_at(self, profile_env, monkeypatch):
        ...
        monkeypatch.setattr(
            "fool_cli.profile_distribution.datetime", _FakeDT, raising=True
        )

        from fool_cli.profile_distribution import update_distribution
...
class TestProfileInfoDistribution:
    ...
    def test_malformed_manifest_does_not_break_list(self, profile_env):
        from fool_cli.profiles import create_profile, list_profiles, get_profile_dir
