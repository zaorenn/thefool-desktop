"""Tests for fool_cli.skin_engine — the data-driven skin/theme system."""
...
def reset_skin_state():
    ...
    from fool_cli import skin_engine
...
class TestSkinConfig:
    def test_default_skin_has_required_fields(self):
        from fool_cli.skin_engine import load_skin
...
class TestSkinManagement:
    def test_set_active_skin(self):
        from fool_cli.skin_engine import set_active_skin, get_active_skin, get_active_skin_name
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        ...
        # Patch skins dir
        monkeypatch.setattr("fool_cli.skin_engine._skins_dir", lambda: skins_dir)
...
class TestDisplayIntegration:
    ...
    def test_tool_message_uses_skin_prefix(self):
        from fool_cli.skin_engine import set_active_skin
...
class TestCliBrandingHelpers:
    ...
    def test_active_goodbye_ares(self):
        from fool_cli.skin_engine import set_active_skin, get_active_goodbye

        set_active_skin("ares")
        assert get_active_goodbye() == "Farewell, warrior! ⚔"

    def test_prompt_toolkit_style_overrides_cover_tui_classes(self):
        from fool_cli.skin_engine import set_active_skin, get_prompt_toolkit_style_overrides
        set_active_skin("ares")
    ...
    def test_prompt_toolkit_style_overrides_use_skin_colors(self):
        from fool_cli.skin_engine import (
            set_active_skin,
            get_active_skin,
