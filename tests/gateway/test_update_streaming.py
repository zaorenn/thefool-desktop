...
Tests the new --gateway mode for fool update, including:
...
class TestGatewayPrompt:
    ...
    def test_writes_prompt_file_and_reads_response(self, tmp_path):
        ...
        with patch.dict(os.environ, {"FOOL_HOME": str(hermes_home)}):
            from fool_cli.main import _gateway_prompt
...
class TestRestoreStashWithInputFn:
    ...
    def test_uses_input_fn_when_provided(self, tmp_path):
        ...
        from fool_cli.main import _restore_stashed_changes
...
class TestUpdateCommandGatewayFlag:
    """Verify the gateway spawns fool update --gateway."""
