...
vi.mock('@/hermes', () => ({
  saveFoolConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setFoolConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useFoolConfigRecord: () => ({ data: mocks.loadedConfig })
}))
