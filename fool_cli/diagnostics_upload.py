...
#
# Kendi toplama ucunu kurmak istersen FOOL_DIAGNOSTICS_BASE_URL ile
# isaretleyebilirsin; akis oldugu gibi calisir.
NAS_BASE = os.environ.get("FOOL_DIAGNOSTICS_BASE_URL", "")
...
def request_upload_url(
    ...
    if not NAS_BASE:
        raise RuntimeError(
            ...
            "uploading, set FOOL_DIAGNOSTICS_BASE_URL to an endpoint you control."
        )
