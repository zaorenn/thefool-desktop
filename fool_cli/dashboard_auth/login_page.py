...
Visual styling mirrors the Fool Labs design system (the
...
``tests/fool_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to The Fool dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — The Fool</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
