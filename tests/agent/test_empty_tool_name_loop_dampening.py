...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated FOOL_HOME, yield (agent, helpers)."""
    ...
    prev_home = os.environ.get("FOOL_HOME")
    os.environ["FOOL_HOME"] = os.path.join(test_home, ".hermes")
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["FOOL_HOME"] = prev_home
