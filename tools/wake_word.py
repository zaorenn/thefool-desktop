...
def enrolled_profile_phrases() -> Dict[str, str]:
    ...
    try:
        ...
        from thefool_cli.profiles import get_profile_dir, list_profiles
...
# THEFOOL_HOME. Keywords are typed phrases tokenized at RUNTIME — no
...
# ---------------------------------------------------------------------------
# Process-wide singleton (mirrors thefool_cli.voice's continuous API)
# ---------------------------------------------------------------------------
