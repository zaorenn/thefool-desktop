...
class InsightsEngine:
    ...
    def __init__(self, db):
        ...
        Args:
            db: A SessionDB instance (from fool_state.py)
        """
        self.db = db
        self._conn = db._conn
    ...
    def _compute_overview(
        ...
        if models:
            ...
            # with the per-model table and stops `fool insights`
    ...
    def format_terminal(self, report: Dict) -> str:
        ...
        lines.append("")
        lines.append("  ╔══════════════════════════════════════════════════════════╗")
        lines.append("  ║                    📊 The Fool Insights                    ║")
    ...
    def format_gateway(self, report: Dict) -> str:
        ...
        lines.append(f"📊 **The Fool Insights** — Last {days} days\n")
