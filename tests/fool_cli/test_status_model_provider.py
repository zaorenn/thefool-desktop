"""Tests for fool_cli.status model/provider display."""

from types import SimpleNamespace

from fool_cli.nous_account import NousPaidServiceAccessInfo, NousPortalAccountInfo
...
def test_show_status_reports_empty_lmstudio_listing_as_reachable(monkeypatch, capsys, tmp_path):
    ...
    monkeypatch.setattr(
        "fool_cli.models.probe_lmstudio_models",
