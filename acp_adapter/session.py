...
def _normalize_cwd_for_compare(cwd: str | None) -> str:
    ...
    from fool_constants import windows_path_to_wsl
...
class SessionManager:
    ...
    def _get_db(self):
        ...
        Note: we resolve ``FOOL_HOME`` dynamically rather than relying on
    ...
    def _restore(self, session_id: str) -> Optional[SessionState]:
        ...
        # for the rest of the session (see fool_state.get_messages_as_conversation).
        try:
