 ...
 *   - THE FOOL wordmark rendered in Collapse Bold, uppercase, tracked
 ...
 * 99% of users; the rest will use the CLI installer with a -FoolHome
    ...
    <div className="hermes-fade-in flex h-full flex-col items-center justify-center gap-10 px-12 py-10">
      ...
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          ...
          <span aria-hidden="true">THE FOOL</span>
        </p>
