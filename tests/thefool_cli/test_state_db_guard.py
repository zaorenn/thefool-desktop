...
from thefool_cli.backup import copy_db_and_verify, verify_sqlite_integrity
...
class TestPreUpdateBackupIntegrityGuard:
    ...
    THEFOOL_HOME whose state.db is corrupted mid-flight (#68474)."""
    ...
    def hermes_home(self, tmp_path, monkeypatch):
        ...
        for mod in list(sys.modules.keys()):
            if mod.startswith("thefool_cli.config") or mod == "thefool_constants":
                del sys.modules[mod]
        return root
