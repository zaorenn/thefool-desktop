...
3. For each merged PR, check if it modified:
   ...
   - CLI commands (fool_cli/commands.py, fool_cli/main.py) — may need docs/reference/cli-commands.md update
   - Config options (fool_cli/config.py) — may need docs/user-guide/configuration.md update
