...
def _prune_env_pool_entries(env_var: str) -> List[str]:
    ...
    """
    from thefool_cli.auth import _auth_store_lock, _load_auth_store, _save_auth_store
...
def save_provider_env_credential(env_var: str, value: str) -> Dict[str, Any]:
    ...
    """
    from thefool_cli.config import load_env, save_env_value
    ...
    # that reads this var.
    try:
        from thefool_cli.auth import unsuppress_credential_source
...
def remove_provider_env_credential(env_var: str) -> Dict[str, Any]:
    ...
    """
    from thefool_cli.config import load_env, remove_env_value
