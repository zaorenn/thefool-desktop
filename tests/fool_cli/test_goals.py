"""Tests for fool_cli/goals.py — persistent cross-turn goals."""
...
def hermes_home(tmp_path, monkeypatch):
    ...
    # Bust the goal-module's DB cache for each test so it re-resolves FOOL_HOME.
...
class TestParseJudgeResponse:
    def test_clean_json_done(self):
        from fool_cli.goals import _parse_judge_response
...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from fool_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, hermes_home):
        ...
        from fool_cli import goals
        from fool_cli.goals import GoalManager, DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES
...
class TestGoalStateSubgoalsBackcompat:
    def test_old_state_meta_row_loads_without_subgoals(self):
        ...
        from fool_cli.goals import GoalState
...
class TestMigrateGoalToSession:
    ...
    def test_migrates_active_goal_to_child(self, hermes_home):
        from fool_cli.goals import save_goal, load_goal, migrate_goal_to_session, GoalState
...
class TestGoalContractSerialization:
    def test_roundtrip_with_contract(self):
        from fool_cli.goals import GoalState, GoalContract
    ...
    def test_render_block_omits_empty_fields(self):
        from fool_cli.goals import GoalContract
...
class TestGoalManagerContract:
    ...
    def test_set_contract_after_the_fact(self, hermes_home):
        from fool_cli.goals import GoalManager, GoalContract
        ...
        # Survives reload.
        from fool_cli.goals import GoalManager as GM2
