...
from thefool_cli import doctor_live
from thefool_cli.doctor_live import (
    ProbeResult,
...
class TestBrowserAvailableNpxRung:
    ...
    def _block_path_and_node_modules_checks(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("thefool_cli.doctor.THEFOOL_HOME", tmp_path / "home")
        monkeypatch.setattr("thefool_cli.doctor.PROJECT_ROOT", tmp_path / "root")
