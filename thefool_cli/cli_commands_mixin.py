...
from thefool_constants import display_hermes_home, is_termux as _is_termux_environment
...
class CLICommandsMixin:
    ...
    def _handle_export_command(self, command: str):
        ...
        """
        from thefool_cli.profiles import export_profile, get_active_profile_name
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        ...
        from cli import _cprint
        from thefool_cli.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        from thefool_cli.clipboard import has_clipboard_image
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in thefool_cli/colors.py
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from thefool_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_personality_command(self, cmd: str):
        ...
        All resolution/persistence goes through thefool_cli.personality —
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from thefool_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_hatch_command(self, cmd: str):
        ...
        from thefool_cli.pets import _set_active
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to thefool_cli.curator so the CLI and the `hermes curator`
        ...
        try:
            from thefool_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to thefool_cli.skills_hub."""
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            if out is not None:
                print(out)
                return
        from thefool_cli.skills_hub import handle_skills_slash
    ...
    def _handle_heartbeat_command(self, cmd: str) -> None:
        ...
        from thefool_cli.heartbeat import parse_interval, format_interval
        ...
        if interval is None:
            ...
            return
        if interval < 0:
            from thefool_cli.heartbeat import MIN_INTERVAL_SECONDS
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        from thefool_cli.goals import parse_contract
    ...
    def _handle_goal_draft(self, objective: str) -> None:
        ...
        from cli import _DIM, _RST, _cprint
        from thefool_cli.goals import draft_contract
    ...
    def _handle_loop_command(self, cmd: str) -> None:
        ...
        from thefool_cli.loops import dispatch_loop_command
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from thefool_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _set_tool_progress_mode(self, mode: str) -> None:
        ...
        """
        from thefool_cli.focus_view import normalize_tool_progress_mode
    ...
    def _note_focus_hidden_line(self, function_name: str) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from thefool_cli.focus_view import would_display_tool_line
    ...
    def _emit_focus_recovery_line(self) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from thefool_cli.focus_view import format_hidden_line
    ...
    def _handle_approvals_command(self, cmd_original: str) -> None:
        ...
        from cli import _cprint
        from thefool_cli.approval_mode import run_approval_mode_command
    ...
    def _handle_indicator_command(self, cmd: str):
        ...
        """
        from cli import _ACCENT, _DIM, _RST, _cprint, save_config_value
        from thefool_constants import DEFAULT_INDICATOR_STYLE, INDICATOR_STYLES
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from thefool_cli.models import _is_anthropic_fast_model
            agent = getattr(self, "agent", None)
    ...
    def _handle_update_command(self) -> bool:
        ...
        when cancelled.
        """
        from thefool_cli.config import is_managed, format_managed_message
