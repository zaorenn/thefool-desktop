...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating The Fool' : 'Setting up Fool Agent'

  const description = isUpdate
    ? 'The Fool is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Fool installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
