...
`fool skills` enters this module.
...
from fool_cli.config import cfg_get, load_config, save_config
from fool_cli.colors import Colors, color
from fool_cli.platforms import PLATFORMS as _PLATFORMS
