...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("FOOL_HOME", os.path.expanduser("~/.hermes")), "skills/red-teaming/godmode/scripts/auto_jailbreak.py")
    )).read())
...
try:
    ...
    _SKILL_DIR = Path(os.getenv("FOOL_HOME", Path.home() / ".hermes")) / "skills" / "red-teaming" / "godmode"
...
PREFILL_PATH = FOOL_HOME / "prefill.json"
