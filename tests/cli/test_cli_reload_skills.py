"""Tests for the ``/reload-skills`` CLI slash command (``FoolCLI._reload_skills``).
...
def _make_cli():
    """Build a minimal FoolCLI shell exposing ``_reload_skills``."""
    import cli as cli_mod

    obj = object.__new__(cli_mod.FoolCLI)
