...
export const af: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk The Fool-inproppe op (`fool plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.fool/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.fool/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.fool/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrêre omgewingsveranderlikes wat in jou .env gestoor is en wat The Fool nie herken nie. Gebruik dit om omgewingsveranderlikes vir vaardighede, MCP-bedieners of jou eie gereedskap in te spuit.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare The Fool-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "The Fool-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik The Fool meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra The Fool 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "The Fool skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
