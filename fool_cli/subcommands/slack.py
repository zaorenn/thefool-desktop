...
def build_slack_parser(subparsers, *, cmd_slack: Callable) -> None:
    ...
    slack_parser = subparsers.add_parser(
        ...
        description="Slack integration helpers for The Fool.",
    )
    ...
    slack_manifest.add_argument(
        ...
        "writes to $FOOL_HOME/slack-manifest.json.",
    )
    slack_manifest.add_argument(
        "--name",
        default=None,
        help='Bot display name (default: "The Fool")',
    )
    slack_manifest.add_argument(
        "--description",
        default=None,
