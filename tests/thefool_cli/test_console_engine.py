...
from thefool_cli.console_engine import HermesConsoleEngine, run_console_repl
...
def test_sessions_export_rejects_oversized_single_before_touching_output(
    ...
    monkeypatch.setattr(thefool_state, "resolved_max_export_messages", lambda: 2)
    materialized = []
...
def test_capture_output_surfaces_string_exit_code_as_command_error():
    from thefool_cli.console_engine import ConsoleCommandError, _capture_output
