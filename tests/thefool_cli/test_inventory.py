"""Behavior tests for thefool_cli.inventory.
...
def test_build_models_payload_forwards_refresh_flag():
    ...
    with patch("thefool_cli.model_switch.list_authenticated_providers", side_effect=_capture):
...
def test_list_authenticated_providers_refresh_busts_cache():
    ...
    with patch("thefool_cli.models.clear_provider_models_cache") as clear:
