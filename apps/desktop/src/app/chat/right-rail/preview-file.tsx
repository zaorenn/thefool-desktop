...
import { THEFOOL_PATHS_MIME } from '@/app/chat/hooks/use-composer-actions'
...
function startLineDrag(event: ReactDragEvent<HTMLElement>, filePath: string, { end, start }: LineSelection) {
  ...
  event.dataTransfer.setData(THEFOOL_PATHS_MIME, JSON.stringify([{ line: start, lineEnd, path: filePath }]))
