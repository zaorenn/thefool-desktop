...
from fool_cli.skills_hub import do_check, do_install, do_list, do_update, handle_skills_slash
...
def _capture_update(monkeypatch, results) -> tuple[str, list[tuple[str, str, bool]]]:
    import tools.skills_hub as hub
    import fool_cli.skills_hub as cli_hub
...
def test_do_search_json_flag_emits_full_identifiers(capsys):
    ...
    from fool_cli.skills_hub import do_search
