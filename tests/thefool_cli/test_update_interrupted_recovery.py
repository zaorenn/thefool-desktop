...
def _stub_install_env(monkeypatch, m, seen):
    ...
    monkeypatch.setattr("thefool_cli.managed_uv.ensure_uv", lambda: None)
    # The install executor moved to thefool_cli._install_repair (shared between
    ...
    import thefool_cli._install_repair as ir
