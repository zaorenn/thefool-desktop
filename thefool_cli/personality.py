...
This module deliberately has no module-level imports from ``thefool_cli.config``
...
def resolve_ephemeral_system_prompt(cfg: Optional[Dict[str, Any]]) -> str:
    ...
    prefer ``THEFOOL_EPHEMERAL_SYSTEM_PROMPT`` when that env var is set.
    """
...
def persist_personality(value: Any) -> bool:
    ...
    THEFOOL_HOME config.yaml atomically, preserving comments and ordering.
