...
def build_session_provenance(
    ...
    *,
    ...
    provenance: Dict[str, Any] = {
        ...
        "currentFoolSessionId": current_hermes_session_id,
        "rootFoolSessionId": root_id,
        "parentFoolSessionId": parent_id,
        "sessionKind": "continuation" if is_continuation else "root",
        "compressionDepth": compression_depth,
    }
    if previous_hermes_session_id:
        provenance["previousFoolSessionId"] = previous_hermes_session_id
    if rotated:
