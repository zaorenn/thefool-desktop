...
Covers the shared prompt builder (thefool_cli.init_command.build_init_prompt)
...
from thefool_cli.init_command import (
    _QUALITY_BAR,
    build_init_prompt,
...
class TestInitRegistryWiring:
    ...
    def test_init_works_on_the_gateway(self):
        ...
        from thefool_cli.commands import GATEWAY_KNOWN_COMMANDS
