...
from thefool_cli.status import _effective_provider_label


def _label_with(config, env_base_url=""):
    with patch("thefool_cli.status.resolve_requested_provider", return_value="auto"), \
         patch("thefool_cli.status.resolve_provider", return_value="openrouter"), \
         patch("thefool_cli.status.load_config", return_value=config), \
         patch("thefool_cli.status.get_env_value",
...
def test_non_openrouter_provider_untouched():
    with patch("thefool_cli.status.resolve_requested_provider", return_value="anthropic"), \
         patch("thefool_cli.status.resolve_provider", return_value="anthropic"):
