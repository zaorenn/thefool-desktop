...
class SessionSearchMixin:
    ...
    def search_messages(
        ...
        Threshold: FOOL_SEARCH_SLOW_MS (default 1000; 0 logs every call).
        """
        started = time.time()
        rows = None
        try:
            ...
            try:
                threshold = float(os.getenv("FOOL_SEARCH_SLOW_MS", "1000"))
    ...
    def optimize_fts(self) -> int:
        ...
        disabled via ``FOOL_DISABLE_FTS_TRIGRAM`` or not yet created), so
