...
class TestVerifyConsoleScriptsInstalled:
    def test_no_action_when_all_shims_present(self, temp_pyproject, fake_scripts_dir):
        ...
        with patch("thefool_cli.main._is_windows", return_value=True), \
             patch("thefool_cli.main._venv_scripts_dir", return_value=fake_scripts_dir), \
             patch("thefool_cli.main._run_quarantined_install") as mock_install:
            from thefool_cli.main import _verify_console_scripts_installed
