...
from thefool_cli.dashboard_auth.base import (
    InvalidCodeError,
    InvalidCredentialsError,
    ProviderError,
)
from thefool_cli.dashboard_auth.cookies import (
    clear_pkce_cookie,
...
from thefool_cli.dashboard_auth.login_page import render_login_html
...
def _redirect_uri(request: Request) -> str:
    ...
    Three resolution tiers:
      ...
      1. ``THEFOOL_DASHBOARD_PUBLIC_URL`` env var or
    ...
    from thefool_cli.dashboard_auth.prefix import (
        prefix_from_request,
        resolve_public_url,
    )
...
def _prefix(request: Request) -> str:
    ...
    ``thefool_cli.dashboard_auth.prefix`` for the normalisation rules.
    """
    from thefool_cli.dashboard_auth.prefix import prefix_from_request
...
async def auth_native_authorize(
    ...
    from thefool_cli.dashboard_auth import native_flow
...
async def api_auth_ws_ticket(request: Request):
    ...
    from thefool_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
...
async def auth_native_refresh(request: Request, body: _NativeRefreshBody):
    ...
    """
    from thefool_cli.dashboard_auth import list_session_providers
    from thefool_cli.dashboard_auth.base import RefreshExpiredError
