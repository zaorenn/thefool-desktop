...
const cases = [
  ...
  // FOOL-SEAM: default-mode -- varsayilan KOYU. Upstream'de 'light'ti; bu
  // sinav o degeri bekliyordu ve dikis konuldugundan beri kirmizi
  // yaniyordu. Yerel arayuz takimi hic kosmadigi icin gorulmedi.
