...
.. code-block:: python
    ...
    from fool_cli.skin_engine import get_active_skin, list_skins, set_active_skin
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces FOOL_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces FOOL_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic The Fool — gold and kawaii",
        ...
        "branding": {
            "agent_name": "Fool Agent",
            "welcome": "Welcome to Fool Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ The Fool ",
            "prompt_symbol": "❯",
