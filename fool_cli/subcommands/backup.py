...
def build_backup_parser(subparsers, *, cmd_backup: Callable) -> None:
    ...
    backup_parser = subparsers.add_parser(
        "backup",
        help="Back up The Fool home directory to a zip file",
        description="Create a zip archive of your entire Fool configuration, "
    ...
    backup_parser.add_argument(
        "-o",
        "--output",
        help="Output path for the zip file (default: ~/fool-backup-<timestamp>.zip)",
    )
    backup_parser.add_argument(
        "-q",
        "--quick",
