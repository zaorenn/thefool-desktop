...
def _split_line(line: str) -> list[str]:
    try:
        ...
        from thefool_cli._subprocess_compat import split_command_line
...
def _dispatch_extracted_subcommand(
    *,
    ...
    parser, subparsers = _parser_root()
    module = importlib.import_module(module_name)
    main_module = importlib.import_module("thefool_cli.main")
    builder = getattr(module, builder_name)
...
class HermesConsoleEngine:
    ...
    def _register_broad_cli_surface(self) -> None:
        ...
        extracted = {
            "version": (
                "thefool_cli.subcommands.version",
            ...
            "prompt-size": (
                "thefool_cli.subcommands.prompt_size",
            ...
            "insights": (
                "thefool_cli.subcommands.insights",
            ...
            "security": (
                "thefool_cli.subcommands.security",
            ...
            "backup": (
                "thefool_cli.subcommands.backup",
                "build_backup_parser",
                "cmd_backup",
                [()],
                {()},
            ...
            "import": (
                "thefool_cli.subcommands.import_cmd",
            ...
            "config": (
                "thefool_cli.subcommands.config",
                "build_config_parser",
                "cmd_config",
                [("env-path",), ("check",)],
                set(),
            ...
            "plugins": (
                "thefool_cli.subcommands.plugins",
            ...
            "skills": (
                "thefool_cli.subcommands.skills",
                "build_skills_parser",
                "cmd_skills",
                [
                    ("browse",),
            ...
            "memory": (
                "thefool_cli.subcommands.memory",
                "build_memory_parser",
                "cmd_memory",
                [("status",), ("off",), ("reset",)],
                {("off",), ("reset",)},
            ...
            "pairing": (
                "thefool_cli.subcommands.pairing",
            ...
            "webhook": (
                "thefool_cli.subcommands.webhook",
            ...
            "profile": (
                "thefool_cli.subcommands.profile",
        ...
        self.register(
            ...
            _adder_handler("send", (), "thefool_cli.send_cmd", "register_send_subparser"),
            mutating=True,
        ...
        _register_command_family(
            ...
            root="portal",
            paths=portal_paths,
            summaries=_adder_summaries("thefool_cli.portal_cli", "add_parser"),
            handler_factory=lambda fixed: _adder_handler(
                "portal",
                fixed,
                "thefool_cli.portal_cli",
                "add_parser",
            ),
        )
        ...
        _register_command_family(
            ...
            summaries=_builder_summaries("thefool_cli.projects_cmd", "build_parser"),
            mutating=[
                ("create",),
                ("add-folder",),
                ("remove-folder",),
        ...
        _register_command_family(
            ...
            summaries=_builder_summaries("thefool_cli.kanban", "build_parser"),
            mutating=[
                ("init",),
                ("boards", "create"),
                ("boards", "rm"),
...
def _logs(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    from thefool_cli.logs import list_logs, tail_log
...
def _config_show(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    from thefool_cli.config import show_config
...
def _config_set(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    key = args[0]
    value = " ".join(args[1:])
    from thefool_cli.config import set_config_value
...
def _sessions_repair(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    def _run() -> None:
        from thefool_state import DEFAULT_DB_PATH, _db_opens_cleanly, repair_state_db_schema
...
def _profile_status(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    return _dispatch_extracted_subcommand(
        ...
        fixed=(),
        args=(),
        module_name="thefool_cli.subcommands.profile",
...
def _cron_list(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    ns = parser.parse_args(args)
    from thefool_cli.cron import cron_list
...
def _cron_status(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    from thefool_cli.cron import cron_status
