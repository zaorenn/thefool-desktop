...
When ``THEFOOL_HOME`` points to a named profile, ``read_credential_pool()``
...
def profile_env(tmp_path, monkeypatch):
    ...
    * Profile     -> tmp_path/.hermes/profiles/coder   (active, THEFOOL_HOME points here)
...
def classic_env(tmp_path, monkeypatch):
    """Classic single-root layout (THEFOOL_HOME != ~/.hermes, no profiles)."""
