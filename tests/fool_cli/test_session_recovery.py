...
import fool_state
from fool_state import FTS_STORAGE_VERSION, SCHEMA_VERSION, SessionDB
from fool_cli import session_recovery
...
def test_snapshot_blocks_connections_opened_during_the_copy(
    ...
    from fool_cli import session_recovery as recovery_module
...
def test_cli_allow_partial_salvages_rows_across_a_corrupt_leaf(
    ...
    env = os.environ.copy()
    env["FOOL_HOME"] = str(tmp_path / "isolated-hermes-home")
