...
code paths in ``thefool_cli/main.py`` that print this notice (the git-pull path
...
import thefool_cli.update_cmd as update_mod
...
def _source_lines() -> list[str]:
    # The update pipeline was extracted to thefool_cli/update_cmd.py
