...
class TestMemoryFamily:
    ...
    def test_supermemory_post_setup_no_environ_write_under_multiplex(
        ...
        import fool_cli.config as cli_config
        import fool_cli.memory_setup as memory_setup
...
class TestGoogleMeetSpawn:
    def test_child_env_carries_scoped_openai_key(
        ...
        monkeypatch.delenv("FOOL_MEET_REALTIME_KEY", raising=False)
        ...
        assert child_env["FOOL_MEET_REALTIME_KEY"] == "scoped-openai-key"
    ...
    def test_explicit_key_argument_still_wins(
        ...
        assert captured["env"]["FOOL_MEET_REALTIME_KEY"] == "explicit-key"
