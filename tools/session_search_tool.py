...
the get_anchored_view / get_messages_around primitives in thefool_state.
...
from thefool_state_common import _RESET_END_REASONS

# Sources that are excluded from session browsing/searching by default.
# Third-party integrations tag their sessions with THEFOOL_SESSION_SOURCE=tool;
