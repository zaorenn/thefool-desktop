...
def _kanban_dispatch_allowed() -> bool:
    """Return False while the global emergency stop (`fool pause`) is engaged.
...
class GatewayKanbanWatchersMixin:
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        no separate `fool kanban daemon` process needed. When false, the
            ...
            try:
                ...
                if _is_corrupt_board_db_error(exc):
                    ...
                    logger.error(
                        ...
                        "then run `fool kanban init` if you need a fresh board.",
                        slug,
                        fingerprint[0],
                    )
                    return None
        ...
        while self._running:
            ...
            try:
                # Global emergency stop (`fool pause`): skip auto-decompose
