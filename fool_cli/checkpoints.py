"""`fool checkpoints` CLI subcommand.
...
from fool_cli.sizefmt import format_bytes as _fmt_bytes
...
def register_cli(parser: argparse.ArgumentParser) -> None:
    """Wire subcommands onto the ``fool checkpoints`` parser."""
    parser.set_defaults(func=cmd_status)  # bare `fool checkpoints` → status
