...
the get_anchored_view / get_messages_around primitives in fool_state.
...
from fool_state_common import _RESET_END_REASONS

# Sources that are excluded from session browsing/searching by default.
# Third-party integrations tag their sessions with FOOL_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches The Fool conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. The Fool renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about The Fool conversation history itself, such "
