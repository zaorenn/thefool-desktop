...
from thefool_cli.web_server import MoaConfigPayload, MoaModelSlot, MoaPresetPayload, set_moa_models
...
class TestSetMoaModelsPreservesUndeclaredKeys:
    ...
    def test_save_traces_preserved(self, tmp_path):
        ...
        with (
            patch("thefool_cli.web_server.load_config", side_effect=fake_load_config),
            patch("thefool_cli.web_server.save_config", side_effect=fake_save_config),
            patch("thefool_cli.web_server._profile_scope"),
        ):
