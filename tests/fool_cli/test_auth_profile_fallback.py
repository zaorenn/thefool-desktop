...
When ``FOOL_HOME`` points to a named profile, ``read_credential_pool()``
...
def profile_env(tmp_path, monkeypatch):
    ...
    * Profile     -> tmp_path/.hermes/profiles/coder   (active, FOOL_HOME points here)
...
def classic_env(tmp_path, monkeypatch):
    """Classic single-root layout (FOOL_HOME != ~/.hermes, no profiles)."""
