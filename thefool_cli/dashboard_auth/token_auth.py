...
How it fits the existing auth framework:
  ...
  * :func:`token_auth_middleware` runs OUTERMOST (installed last in
    ...
    :class:`~thefool_cli.dashboard_auth.base.TokenPrincipal` to
...
from thefool_cli.dashboard_auth import list_token_providers
from thefool_cli.dashboard_auth.audit import AuditEvent, audit_log
from thefool_cli.dashboard_auth.base import ProviderError, TokenPrincipal
