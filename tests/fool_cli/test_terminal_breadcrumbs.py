"""Tests for fool_cli/terminal_breadcrumbs.py — per-terminal ``hermes -c``.

Covers terminal id derivation (tty vs env vars vs none), breadcrumb
write/read roundtrip under a temp FOOL_HOME, stale-session fallback
...
from fool_cli import terminal_breadcrumbs as tb
