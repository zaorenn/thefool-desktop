...
``thefool_cli/main.py:main()`` (god-file Phase 2); handler injected to avoid
importing ``main``.
"""
...
def build_dashboard_parser(
    ...
    # (cmd_dashboard exports THEFOOL_SERVE_HEADLESS=1). `dashboard` leaves it
    ...
    dashboard_register_parser = dashboard_subparsers.add_parser(
        ...
        description=(
            ...
            "THEFOOL_DASHBOARD_OAUTH_CLIENT_ID into ~/.hermes/.env, and prints "
    ...
    dashboard_register_parser.add_argument(
        ...
        help=(
            ...
            "portal. Also settable via THEFOOL_DASHBOARD_PORTAL_URL. Mainly for "
