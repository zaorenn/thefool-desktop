"""Tests for thefool_cli.context_switch_guard."""
...
def test_merge_appends_to_existing_warning(monkeypatch):
    monkeypatch.setattr(
        "thefool_cli.context_switch_guard._estimate_tokens",
        lambda *a, **k: 90_000,
    )
    monkeypatch.setattr(
        "thefool_cli.context_switch_guard.resolve_display_context_length",
        lambda *a, **k: 32_000,
    )
