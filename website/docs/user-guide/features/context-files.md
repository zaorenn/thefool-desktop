...
Hermes Agent automatically discovers and loads context files that shape how it behaves. Some are project-local and discovered from your working directory. `SOUL.md` is now global to the Hermes instance and is loaded from `FOOL_HOME` only.
...
| **SOUL.md** | Global personality and tone customization for this Hermes instance | `FOOL_HOME/SOUL.md` only |
...
- `~/.hermes/SOUL.md`
- or `$FOOL_HOME/SOUL.md` if you run Hermes with a custom home directory
