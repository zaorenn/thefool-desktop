...
def _(rid, params: dict) -> dict:
    ...
    try:
        from fool_cli.commands import SlashCommandCompleter
...
def _(rid, params: dict) -> dict:
    try:
        from fool_cli.inventory import build_model_options_payload
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from fool_cli.inventory import build_models_payload
...
def _(rid, params: dict) -> dict:
    ...
    """
    try:
        from fool_cli.auth import PROVIDER_REGISTRY, clear_provider_auth
