...
ACCEPT = [
    "pythonw.exe -m fool_cli.main gateway run",
    r"C:\Users\me\hermes\venv\Scripts\pythonw.exe -m fool_cli.main gateway run",
    "python -m fool_cli.main --profile work gateway run",
    ...
    r'"C:\Program Files\Py\pythonw.exe" -m fool_cli.main gateway run',
]

REJECT = [
    "python -m tui_gateway",                              # unrelated module
    "python -m fool_cli.main gateway status",           # other subcommand
    "python -m fool_cli.main gateway restart",
    "python -m fool_cli.main gateway stop",
    "python -m fool_cli.main --profile x dashboard",    # non-gateway subcommand
