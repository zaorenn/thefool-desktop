...
const remoteConn = (over: Partial<FoolConnection> = {}): FoolConnection =>
  ({ baseUrl: 'https://fool-roy.tail.ts.net', mode: 'remote', profile: 'vps-remote', ...over }) as FoolConnection
...
beforeEach(() => {
  ...
  $profiles.set([])
  vi.stubGlobal('window', { foolDesktop: { getConnection } })
