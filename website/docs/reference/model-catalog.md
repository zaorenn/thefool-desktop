...
| When | What happens |
|---|---|
| `/model` or `fool model` | Fetches if disk cache is stale, else uses cache |
...
# editing OPENROUTER_MODELS or _PROVIDER_MODELS["nous"] in fool_cli/models.py).
