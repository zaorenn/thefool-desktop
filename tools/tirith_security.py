...
it is automatically downloaded from GitHub releases to $FOOL_HOME/bin/tirith.
...
def _get_hermes_home() -> str:
    """Return the Hermes home directory, respecting FOOL_HOME env var."""
...
def _hermes_bin_dir() -> str:
    """Return $FOOL_HOME/bin, creating it if needed."""
...
def _install_tirith(*, log_failures: bool = True) -> tuple[str | None, str]:
    """Download and install tirith to $FOOL_HOME/bin/tirith.
...
def _resolve_tirith_path(configured_path: str) -> str:
    ...
    2. $FOOL_HOME/bin/tirith (previously auto-installed)
    3. Auto-install from GitHub releases → $FOOL_HOME/bin/tirith
