...
from fool_cli.session_lost_and_found import (
...
from tests.fool_cli.test_session_recovery import (
    _btree_leaf_pages,
    _make_page_spanning_source,
)


from fool_cli.session_lost_and_found import find_sqlite3_cli
...
def test_unreadable_schema_without_cli_names_the_sqlite3_requirement(
    ...
    import fool_cli.session_lost_and_found as laf
