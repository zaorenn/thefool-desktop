...
from thefool_cli.config import get_hermes_home, get_config_path, load_config, save_config
...
def _cmd_migrate(args):
    ...
    # Delegates to thefool_cli.backup.create_pre_migration_backup(), which
    ...
    if not no_backup:
        try:
            from thefool_cli.backup import create_pre_migration_backup, _format_size
