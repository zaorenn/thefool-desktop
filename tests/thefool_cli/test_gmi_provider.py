...
class TestGmiAliases:
    ...
    def test_providers_normalize_provider(self):
        from thefool_cli.providers import normalize_provider as normalize_provider_in_providers
...
class TestGmiProvidersModule:
    def test_overlay_exists(self):
        ...
        assert "gmi" in THEFOOL_OVERLAYS
        overlay = THEFOOL_OVERLAYS["gmi"]
...
class TestGmiDoctor:
    def test_provider_env_hints_include_gmi(self):
        from thefool_cli.doctor import _PROVIDER_ENV_HINTS
...
class TestGmiMainFlow:
    def test_chat_parser_accepts_gmi_provider(self, monkeypatch):
        ...
        monkeypatch.setattr("thefool_cli.config.get_container_exec_info", lambda: None)
        monkeypatch.setattr(
            "thefool_cli.main.cmd_chat",
    ...
    def test_select_provider_and_model_routes_gmi_to_generic_flow(self, monkeypatch):
        ...
        monkeypatch.setattr("thefool_cli.auth.resolve_provider", lambda *args, **kwargs: None)
        ...
        monkeypatch.setattr("thefool_cli.main._model_flow_api_key_provider", fake_model_flow_api_key_provider)
    ...
    def test_model_flow_api_key_provider_persists_gmi_selection(self, monkeypatch):
        ...
        with patch(
            ...
            "thefool_cli.auth.deactivate_provider",
        ), patch(
            "builtins.input",
            return_value="",
        ):
            from thefool_cli.main import _model_flow_api_key_provider
