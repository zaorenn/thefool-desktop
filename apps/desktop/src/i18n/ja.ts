...
export const ja = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'リモートホストに The Fool がインストールされていません。リモートでインストールする（curl -fsSL https://raw.githubusercontent.com/zaorenn/fool-agent/main/scripts/install.sh | sh）か、The Fool パスを設定してください。',
      sshErrPlatform:
