...
def test_ws_events_rejects_when_token_required(tmp_path, monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "thefool_cli.web_server", stub)
    monkeypatch.setattr(thefool_cli, "web_server", stub, raising=False)
...
# tests/thefool_cli/test_kanban_db.py. The OUTER fallback here is not, which
