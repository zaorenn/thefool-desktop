...
def active_session_limit_message(
    ...
    return (
        f"The Fool is at the active session limit ({active_count}/{max_sessions})."
...
class ActiveSessionLease:
    ...
    # root ``FOOL_HOME`` must release against the same registry even when
...
def release_active_session(lease: ActiveSessionLease) -> None:
    ...
    # running under a profile FOOL_HOME override (#85431).
