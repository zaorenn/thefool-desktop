...
from thefool_cli.config import get_hermes_home, get_env_path, get_project_root, load_config
...
def _get_git_commit(project_root: Path) -> str:
    ...
    ``THEFOOL_GIT_SHA`` build-arg (see ``thefool_cli/build_info.py``).
...
def _gateway_status() -> str:
    ...
    try:
        from thefool_cli.gateway import get_gateway_runtime_snapshot
