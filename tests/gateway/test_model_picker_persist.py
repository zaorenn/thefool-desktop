...
closure the PR changed, against a real temp ``THEFOOL_HOME``.
"""
...
def _stub_picker_dependencies(monkeypatch):
    ...
    monkeypatch.setattr(
        "thefool_cli.model_switch.list_picker_providers",
    ...
    monkeypatch.setattr(
        "thefool_cli.model_switch.resolve_display_context_length",
        lambda *a, **k: 272000,
    )
