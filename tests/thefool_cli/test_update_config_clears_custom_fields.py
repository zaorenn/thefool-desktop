"""Tests for thefool_cli.auth._update_config_for_provider clearing stale fields.
...
from thefool_cli.config import clear_model_endpoint_credentials, get_config_path
