...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateHermes: "The Fool'i Güncelle",
    updatingHermes: "The Fool güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "The Fool eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`fool plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.fool/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.fool/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.fool/skills/ adresinden yüklenir",
  ...
  env: {
    ...
    customHint: ".env dosyanızda saklanan ve The Fool'in tanımadığı rastgele ortam değişkenleri. Bunları beceriler, MCP sunucuları veya kendi araçlarınız için ortam değişkenleri eklemek için kullanın.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk The Fool rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "The Fool oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "The Fool'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. The Fool ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "The Fool yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
