...
from fool_cli.providers import normalize_provider as normalize_overlay_provider
...
def test_actual_profile_fetch_models_normalizes_env_base_url(monkeypatch):
    ...
    monkeypatch.setattr("fool_cli.urllib_security.open_credentialed_url", _open)
