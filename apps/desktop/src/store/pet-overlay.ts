 ...
 * app's bounds and stays visible while The Fool is minimized. That window carries
...
const OVERLAY_ACTIVE_KEY = 'fool.desktop.pet-overlay-active.v1'
const OVERLAY_BOUNDS_KEY = 'fool.desktop.pet-overlay-bounds.v1'
