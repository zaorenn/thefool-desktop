"""Tests for fool_cli/completion.py — shell completion script generation."""
...
from fool_cli.completion import _walk, generate_bash, generate_zsh, generate_fish
...
class TestProfileCompletion:
    ...
    def test_bash_profile_actions_complete_profile_names(self):
        """After 'fool profile use', complete with profile names."""
        out = generate_bash(_make_parser())
