...
def isolated_home(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("THEFOOL_HOME", str(hermes))
...
def test_aborted_setup_does_not_enable_whatsapp(isolated_home, monkeypatch):
    ...
    """
    from thefool_cli.main import cmd_whatsapp
    ...
    monkeypatch.setattr("thefool_cli.main._require_tty", lambda *_a, **_kw: None)
