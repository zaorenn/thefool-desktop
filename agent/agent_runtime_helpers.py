...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        if env_var_enabled("THEFOOL_DUMP_REQUEST_STDOUT"):
...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    if eff_provider.strip().lower() == "moa":
        try:
            from thefool_cli.config import load_config as _load_moa_cfg
    ...
    if is_anthropic_wire or _litellm_openai_wire:
        try:
            from thefool_cli.config import get_custom_provider_model_capability
...
def switch_model(agent, new_model, new_provider, api_key='', base_url='', api_mode=''):
    ...
    try:
        ...
        from thefool_cli.config import load_config as _sm_load_config
