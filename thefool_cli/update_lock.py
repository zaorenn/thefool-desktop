...
unchanged and remain byte-compatible with the Rust and Electron readers:
    ...
    <THEFOOL_HOME>/.hermes-update-in-progress   body: "<pid>\\n<started_at_unix>"
...
HANDOFF_PID_ENV = "THEFOOL_UPDATE_HANDOFF_PID"
...
def update_marker_path() -> Path:
    ...
    the Rust updater resolves ``$THEFOOL_HOME`` or the platform default, and the
