"""Regression tests: profile FOOL_HOME override in ephemeral agent threads (#50233).
...
``FOOL_HOME`` ContextVar set on the session-create thread does NOT propagate to
