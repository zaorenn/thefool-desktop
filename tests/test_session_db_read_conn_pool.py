...
``fool_cli.sqlite_safe_read``'s registry permanently over-counted as well.
...
def test_read_open_failure_backs_off_but_recovers(db):
    ...
    from fool_state import _READ_OPEN_RETRY_SECONDS
...
def test_peak_live_connections_bounded_under_simultaneous_burst(db):
    ...
    """
    from fool_state import _READ_POOL_MAX
