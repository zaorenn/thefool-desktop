"""Tests for thefool_cli/completion.py — shell completion script generation."""
...
from thefool_cli.completion import _walk, generate_bash, generate_zsh, generate_fish
