...
ContextVar resolves to the child id (get_session_env / FOOL_SESSION_ID).
"""
...
def test_f5_session_contextvar_rebound_after_rotation(
    ...
    """Post-compression tool reads of FOOL_SESSION_ID see the CHILD id."""
    ...
    try:
        assert get_session_env("FOOL_SESSION_ID") == parent_sid
        ...
        assert get_session_env("FOOL_SESSION_ID") == agent.session_id, (
