...
_VARS = ("FOOL_SAFE_MODE", "FOOL_IGNORE_USER_CONFIG", "FOOL_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["FOOL_SAFE_MODE"] == "1"
        assert os.environ["FOOL_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["FOOL_IGNORE_RULES"] == "1"
        return True
