...
export const ZOOM_STORAGE_KEY = 'fool:desktop:zoomLevel'
 ...
 * but forgot to emit 'fool:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('fool:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
