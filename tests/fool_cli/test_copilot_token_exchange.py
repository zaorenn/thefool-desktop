...
def _clear_jwt_cache():
    ...
    import fool_cli.copilot_auth as mod
...
class TestExchangeCopilotToken:
    ...
    def test_exchanges_token_successfully(self, mock_urlopen):
        from fool_cli.copilot_auth import exchange_copilot_token
...
class TestGetCopilotApiToken:
    ...
    @patch("fool_cli.copilot_auth.exchange_copilot_token")
    def test_returns_exchanged_token(self, mock_exchange):
        from fool_cli.copilot_auth import get_copilot_api_token
...
class TestTokenFingerprint:
    ...
    def test_consistent(self):
        from fool_cli.copilot_auth import _token_fingerprint
...
class TestCallerIntegration:
    ...
    @patch("fool_cli.copilot_auth.resolve_copilot_token", return_value=("gho_raw", "GH_TOKEN"))
    @patch("fool_cli.copilot_auth.get_copilot_api_token", return_value=("exchanged_jwt", None))
...
class TestDeriveBaseUrlFromProxyEp:
    ...
    def test_extracts_enterprise_url(self):
        from fool_cli.copilot_auth import _derive_base_url_from_proxy_ep
...
class TestExchangeFailureFastPath:
    ...
    def test_transient_failure_still_retries_then_caches(self, mock_urlopen, mock_sleep):
        import fool_cli.copilot_auth as mod
        from fool_cli.copilot_auth import exchange_copilot_token, _token_fingerprint
    ...
    def test_evict_clears_negative_cache(self):
        import fool_cli.copilot_auth as mod
        from fool_cli.copilot_auth import evict_cached_exchanged_token, _token_fingerprint
