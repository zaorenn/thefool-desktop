"""Tests for the secret-source tracking in ``thefool_cli.env_loader``.
...
def test_apply_external_secret_sources_dedupes_within_process(tmp_path, monkeypatch):
    ...
    hot modules (cli.py, thefool_cli/main.py, run_agent.py, ...).  The
    ...
    runs exactly once per THEFOOL_HOME per process.
    """
    ...
    # cli.py, thefool_cli/main.py, run_agent.py, trajectory_compressor.py,
