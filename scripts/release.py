...
VERSION_FILE = REPO_ROOT / "fool_cli" / "__init__.py"
...
LEGACY_AUTHOR_MAP = {
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level FOOL_HOME for pid/lock/status identity files; #56986)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (FOOL_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (FOOL_HOME inject)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level FOOL_HOME state files)
