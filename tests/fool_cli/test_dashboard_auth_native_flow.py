...
Run: pytest tests/fool_cli/test_dashboard_auth_native_flow.py
"""
...
from fool_cli.dashboard_auth.base import Session
...
@pytest.fixture
def pw_gated_client():
    from fool_cli.dashboard_auth.routes import _reset_password_rate_limit
    from tests.fool_cli.test_dashboard_auth_password_login import (
        PasswordProvider,
    )
