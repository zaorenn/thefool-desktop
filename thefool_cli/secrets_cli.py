...
# this module is registered parse-time from ``thefool_cli.main`` and must not
...
def __getattr__(name: str):
    ...
    ``thefool_cli.secrets_cli.bw`` directly.  Resolving that attribute at
    ...
    the first actual attribute access, so ``import thefool_cli.secrets_cli``
...
# ---------------------------------------------------------------------------
# Argparse wiring — called from thefool_cli.main
# ---------------------------------------------------------------------------
...
def register_cli(parent_parser: argparse.ArgumentParser) -> None:
    ...
    Called from ``thefool_cli.main`` as part of building the top-level
