"""Tests for MCP tools interactive configuration in fool_cli.tools_config."""

from unittest.mock import patch

from fool_cli.tools_config import _configure_mcp_tools_interactive

# Patch targets: imports happen inside the function body, so patch at source
_PROBE = "tools.mcp_tool.probe_mcp_server_tools"
_CHECKLIST = "fool_cli.curses_ui.curses_checklist"
_SAVE = "fool_cli.tools_config.save_config"
