...
late-binding seam in :mod:`thefool_cli.web_deps` (``late`` for callables,
...
async def get_toolsets(profile: Optional[str] = None):
    ...
    from thefool_cli.platforms import platform_label
...
async def run_toolset_post_setup(
    ...
    write per-profile state must see the same THEFOOL_HOME the rest of the
