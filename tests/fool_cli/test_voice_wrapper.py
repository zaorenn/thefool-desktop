"""Tests for ``fool_cli.voice`` — the TUI gateway's voice wrapper.
...
class TestNormalizeVoiceRecordKeyForPromptToolkit:
    ...
    def test_non_string_falls_back_to_default(self):
        from fool_cli.voice import normalize_voice_record_key_for_prompt_toolkit
    ...
    def test_pt_key_to_sequence(self):
        from fool_cli.voice import pt_key_to_sequence
...
class TestVoiceRecordKeyFromConfig:
    ...
    def test_missing_record_key_returns_none(self):
        from fool_cli.voice import voice_record_key_from_config
