...
def _stub_install_env(monkeypatch, m, seen):
    ...
    monkeypatch.setattr("fool_cli.managed_uv.ensure_uv", lambda: None)
    # The install executor moved to fool_cli._install_repair (shared between
    ...
    import fool_cli._install_repair as ir
