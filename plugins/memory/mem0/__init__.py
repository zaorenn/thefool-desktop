...
Configuration
-------------
Secret (lives in $FOOL_HOME/.env or the environment):
...
def _load_config() -> dict:
    """Load config from env vars, with $FOOL_HOME/mem0.json overrides.
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, hermes_home):
        """Write config to $FOOL_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $FOOL_HOME/mem0.json) —
