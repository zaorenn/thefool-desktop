/**
 * The Fool Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 ...
 *
 * Versioning: bump ``FoolPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@fool/dashboard-plugin-sdk`` types package, or
...
export interface FoolPluginSDK {
...
declare global {
  interface Window {
    __HERMES_PLUGIN_SDK__?: FoolPluginSDK;
