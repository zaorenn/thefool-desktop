...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`fool_cli.slash_exec.EXECUTORS`, and
...
from fool_cli.commands import COMMAND_REGISTRY, resolve_command
from fool_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
