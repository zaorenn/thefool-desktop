...
class TestGetCopilotModelContext:
    ...
    @patch("thefool_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("thefool_cli.models._urlopen_model_catalog_request")
    ...
    @patch("thefool_cli.models.fetch_github_model_catalog", return_value=[])
