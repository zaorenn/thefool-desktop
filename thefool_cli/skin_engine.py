...
.. code-block:: python
    ...
    from thefool_cli.skin_engine import get_active_skin, list_skins, set_active_skin
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces THEFOOL_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces THEFOOL_CADUCEUS)
