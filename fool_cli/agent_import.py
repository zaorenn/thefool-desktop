...
--------
claude-code (~/.claude):
    CLAUDE.md                       → memory entries in FOOL_HOME/memories/MEMORY.md
    ...
    skills/<name>/SKILL.md          → FOOL_HOME/skills/claude-code-imports/<name>/

codex (~/.codex):
    AGENTS.md                       → memory entries in FOOL_HOME/memories/MEMORY.md
    config.toml [mcp_servers.*]     → config.yaml mcp_servers
    memories/*.md                   → memory entries in FOOL_HOME/memories/MEMORY.md
    skills/<name>/SKILL.md          → FOOL_HOME/skills/codex-imports/<name>/
...
class AgentImporter:
    ...
    def import_skills(self, source_root: Path) -> None:
        """skills/<name>/SKILL.md dirs → FOOL_HOME/skills/<category>/<name>."""
...
def print_import_report(report: Dict[str, Any], dry_run: bool) -> None:
    ...
    from fool_cli.setup import Colors, color, print_header, print_info
