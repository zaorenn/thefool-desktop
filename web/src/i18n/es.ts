...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateHermes: "Actualizar The Fool",
    updatingHermes: "Actualizando The Fool…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de The Fool (equivalente a `fool plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.fool/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.fool/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.fool/skills/",
  ...
  env: {
    ...
    customHint: "Variables de entorno arbitrarias almacenadas en tu .env que The Fool no reconoce. Úsalas para inyectar variables de entorno para skills, servidores MCP o tus propias herramientas.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Insignias coleccionables de The Fool ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de The Fool. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa The Fool más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que The Fool detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "The Fool está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
