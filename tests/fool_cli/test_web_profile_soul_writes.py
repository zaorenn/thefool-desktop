...
def client(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("FOOL_DASHBOARD_SESSION_TOKEN", "soul-test-token")
...
def profile_dir(tmp_path, monkeypatch) -> Path:
    """Create a real profile directory under the test FOOL_HOME."""
    monkeypatch.setenv("FOOL_HOME", str(tmp_path))
...
class TestSoulWriteDurability:
    ...
    def test_existing_soul_survives_an_interrupted_save(
        ...
        # FOOL_HOME patch the client/profile_dir fixtures installed.
