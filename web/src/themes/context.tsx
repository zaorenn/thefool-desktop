...
const STORAGE_KEY = "fool-dashboard-theme";
...
const FONT_STORAGE_KEY = "fool-dashboard-font";
...
const CUSTOM_CSS_STYLE_ID = "fool-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-fool-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-fool-theme-font", "true");
