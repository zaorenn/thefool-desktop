...
# dict in fool_cli/gateway.py, and the _send_dingtalk dispatch in
...
def interactive_setup() -> None:
    ...
    Replaces fool_cli/setup.py-era _setup_dingtalk + the static
    _PLATFORMS["dingtalk"] dict in fool_cli/gateway.py. CLI helpers are
    ...
    if method == 0:
        try:
            from fool_cli.dingtalk_auth import dingtalk_qr_auth
