...
export const ar = defineLocale({
  ...
  pluginsPage: {
    ...
    headline:
      "اكتشف وثبِّت وفعِّل وحدِّث مكوِّنات The Fool الإضافية (مطابقة `fool plugins`).",
    ...
    removeConfirm: "إزالة هذا المكوِّن الإضافي من ~/.fool/plugins/؟",
    removeHint: "يمكن إزالة المكوِّنات المثبتة من المستخدم تحت ~/.fool/plugins فقط.",
  ...
  skills: {
    ...
    categories: "الفئات",
    filters: "الفلاتر",
    noSkills: "لم يُعثر على مهارات. يتم تحميل المهارات من ~/.fool/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "إنجازات The Fool",
      subtitle:
        "شارات The Fool قابلة للجمع مكتسبة من سجل الجلسات الفعلي. الإنجازات غير المكتملة المعروفة تُعرض كـ Discovered؛ تبقى الإنجازات السرية مخفية حتى يظهر السلوك المطابق لأول مرة.",
      scan_subtitle:
        "فحص سجل جلسات The Fool. يمكن أن يستغرق الفحص الأول 5–10 ثوانٍ على السجلات الكبيرة.",
    },
    actions: {
      rescan: "إعادة الفحص",
    },
    stats: {
      ...
      latest: "الأحدث",
      latest_hint_empty: "شغِّل The Fool أكثر",
    ...
    guide: {
      ...
      secret_body:
        "تخفى الأسرار محددها الدقيق. بمجرد أن ترى The Fool إشارة ذات صلة، تصبح البطاقة مكتشفة وتعرض متطلباتها.",
      scan_status_header: "حالة الفحص",
      scan_status_body:
        "تُفحص The Fool السجل المحلي مرة واحدة، ثم تظهر البطاقات تلقائيًا. لا يوجد توقف إذا استغرق هذا بضع ثوانٍ.",
    ...
    share: {
      ...
      tweet_text: "فتحت للتو {tier_part}\"{name}\" في Fool Agent ☤"
    },
  },
