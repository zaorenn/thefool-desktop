...
$THEFOOL_OSINT_CACHE/icij/ (default: ~/.cache/hermes-osint/icij/) and search
...
def _cache_dir() -> Path:
    base = os.environ.get("THEFOOL_OSINT_CACHE")
    if base:
...
def main() -> int:
    ...
    p.add_argument(
        ...
        type=Path,
        default=None,
        help="Override cache directory (default: $THEFOOL_OSINT_CACHE/icij or ~/.cache/hermes-osint/icij)",
    )
    p.add_argument(
        "--force-refresh",
        action="store_true",
