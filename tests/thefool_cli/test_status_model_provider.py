"""Tests for thefool_cli.status model/provider display."""

from types import SimpleNamespace

from thefool_cli.nous_account import NousPaidServiceAccessInfo, NousPortalAccountInfo
...
def test_show_status_displays_configured_dict_model_and_provider_label(monkeypatch, capsys, tmp_path):
    from thefool_cli import status as status_mod
...
def test_show_status_reports_empty_lmstudio_listing_as_reachable(monkeypatch, capsys, tmp_path):
    ...
    monkeypatch.setattr(
        "thefool_cli.models.probe_lmstudio_models",
