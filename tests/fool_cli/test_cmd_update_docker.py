...
from fool_cli.main import _cmd_update_check, cmd_update
...
@patch("fool_cli.config.detect_install_method", return_value="docker")
...
def test_format_docker_update_message_contents():
    ...
    assert "FOOL_HOME" in msg or "/opt/data" in msg, (
