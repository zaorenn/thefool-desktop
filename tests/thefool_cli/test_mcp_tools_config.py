"""Tests for MCP tools interactive configuration in thefool_cli.tools_config."""

from unittest.mock import patch

from thefool_cli.tools_config import _configure_mcp_tools_interactive

# Patch targets: imports happen inside the function body, so patch at source
_PROBE = "tools.mcp_tool.probe_mcp_server_tools"
_CHECKLIST = "thefool_cli.curses_ui.curses_checklist"
_SAVE = "thefool_cli.tools_config.save_config"
