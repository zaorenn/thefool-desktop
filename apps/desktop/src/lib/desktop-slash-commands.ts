...
/** Why a known Fool command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Fool profile', surface: action('profile') },
  {
    name: '/skin',
  ...
  { name: '/version', description: 'Show Fool Agent version', surface: exec() },
 ...
 * The Fool' built-in slash commands — i.e. skill commands (`/gif-search`,
 ...
 * activity — the ones that ship with The Fool and were never asked for. It is
