...
```bash
GSETUP="python ${FOOL_HOME:-$HOME/.hermes}/skills/productivity/google-workspace/scripts/setup.py"
```
...
```bash
GAPI="python ${FOOL_HOME:-$HOME/.hermes}/skills/productivity/google-workspace/scripts/google_api.py"
```
