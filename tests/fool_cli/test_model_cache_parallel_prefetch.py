...
# ---------------------------------------------------------------------------
# Thread-safe cache entry update (fool_cli/models.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Parallel prefetch (fool_cli/model_switch.py)
# ---------------------------------------------------------------------------
...
class TestPrefetchProviderModelsParallel:
    ...
    def test_skips_all_fresh_entries(self, monkeypatch):
        ...
        from fool_cli.model_switch import _prefetch_provider_models_parallel
        ...
        with patch("fool_cli.models._load_provider_models_cache", return_value=fresh_cache), \
             patch("fool_cli.models._credential_fingerprint", return_value="fp"), \
             patch("fool_cli.models.cached_provider_model_ids") as fetch:
    ...
    def test_fetches_only_stale_entries(self, monkeypatch):
        ...
        with patch("fool_cli.models._load_provider_models_cache", return_value=cache), \
             patch("fool_cli.models._credential_fingerprint", return_value="fp_f"), \
             patch("fool_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("fool_cli.models.update_provider_cache_entry"):
    ...
    def test_fetches_in_parallel(self, monkeypatch):
        ...
        with patch("fool_cli.models._load_provider_models_cache", return_value={}), \
             patch("fool_cli.models._credential_fingerprint", return_value="fp"), \
             patch("fool_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("fool_cli.models.update_provider_cache_entry"):
    ...
    def test_empty_list_is_noop(self):
        ...
        with patch("fool_cli.models.cached_provider_model_ids") as fetch:
