...
verbatim from thefool_cli/config.py. Must not import from thefool_cli.config.
"""
...
DEFAULT_CONFIG = {
    ...
    "session": {
        ...
        # under $THEFOOL_HOME/terminal-sessions/<terminal-id>, and a bare
    ...
    "agent": {
        ...
        # identity slot (SOUL.md). Empty by default. The THEFOOL_ENVIRONMENT_HINT
        ...
        # ``THEFOOL_LOCAL_STREAM_STALE_TIMEOUT`` overrides for escape-hatch use.
    ...
    "terminal": {
        ...
        #             THEFOOL_HOME/home for persistent state (default)
        #   real    — force the real OS-user HOME
        #   profile — force THEFOOL_HOME/home when it exists (old strict
    ...
    "display": {
        ...
        # REPL and `--tui` (or THEFOOL_TUI=1) forces the TUI regardless of config.
        "interface": "cli",
        # When true, `hermes --tui` auto-resumes the most recent human-
        # facing session on launch instead of forging a fresh one.
        # Mirrors `hermes -c` muscle memory.  Default off so existing
        # users aren't surprised.  THEFOOL_TUI_RESUME=<id> always wins.
        ...
        # model — see thefool_cli/focus_view.py.
        "focus_view": False,
        ...
        # can set `path`/`paths` to THEFOOL_HOME-relative YAML files/directories
    ...
    "dashboard": {
        ...
        # ``THEFOOL_DASHBOARD_OAUTH_CLIENT_ID`` and
        # ``THEFOOL_DASHBOARD_PORTAL_URL`` respectively — and the env var
        ...
        # ``THEFOOL_DASHBOARD_DRAIN_SECRET`` env var (the .env-is-for-secrets
        ...
        # Public URL override (env: ``THEFOOL_DASHBOARD_PUBLIC_URL``).
    ...
    "skills": {
        ...
        # Substitute ${THEFOOL_SKILL_DIR} and ${THEFOOL_SESSION_ID} in SKILL.md
    ...
    # dangerous command. -q runs export THEFOOL_INTERACTIVE=1 (for interactive
    ...
    "approvals": {
        ...
        # modal; THEFOOL_TUI_NO_CONFIRM=1 force-skips that modal regardless of
    ...
    # toggleable per-invocation via --accept-hooks or THEFOOL_ACCEPT_HOOKS=1.
    ...
    "security": {
        ...
        # ``thefool_cli/security_advisories.py`` for the catalog.
        "acked_advisories": [],
    ...
    "cron": {
        ...
        # $THEFOOL_HOME/plugins/<name>/) to relocate the trigger — e.g. "chronos",
        ...
        # Also overridable via THEFOOL_CRON_MAX_PARALLEL env var.
        ...
        # THEFOOL_CRON_SCRIPT_TIMEOUT. Keep this in sync with
        ...
        # THEFOOL_CRON_SESSION_DB_TIMEOUT env var. 0 = unlimited (skip the bound).
    ...
    "gateway": {
        ...
        # internal THEFOOL_GATEWAY_PLATFORM_CONNECT_TIMEOUT env var, which still
        ...
        # the THEFOOL_SCALE_TO_ZERO env stamp) AND messaging is relay-only/absent
        ...
        # ``THEFOOL_GATEWAY_MAX_STARTS`` / ``THEFOOL_GATEWAY_START_WINDOW_S``
        ...
        # user. Bridged to THEFOOL_MEDIA_DELIVERY_STRICT.
        "strict": False,
        ...
        # to THEFOOL_MEDIA_ALLOW_DIRS at gateway startup. Tilde paths are
        ...
        # THEFOOL_MEDIA_TRUST_RECENT_FILES. Only consulted when ``strict``
        # is true; in default mode the denylist alone gates delivery.
        "trust_recent_files": True,
        # Recency window in seconds. 600 (10 min) comfortably covers a
        # multi-tool agent turn. Bridged to THEFOOL_MEDIA_TRUST_RECENT_SECONDS.
    ...
    "sessions": {
        ...
        # serve the cjk index. Bridged to THEFOOL_CJK_FTS (internal carrier).
        "cjk_fts": True,
        ...
        # THEFOOL_SEARCH_SLOW_MS (internal carrier).
        "search_slow_ms": 1000,
    ...
    "updates": {
        ...
        #     DBs) into <THEFOOL_HOME>/state-snapshots/ before the update.
        ...
        #     of THEFOOL_HOME into <THEFOOL_HOME>/backups/, restorable with
    ...
    "lsp": {
        ...
        #              ``<THEFOOL_HOME>/lsp/bin/`` on first use.
    ...
    "desktop": {
        ...
        # Bridged to the THEFOOL_DESKTOP_DISABLE_GPU env var the Electron app reads.
        "disable_gpu": "auto",
        ...
        # Ignored on macOS/Windows. Bridged to the THEFOOL_DESKTOP_PASSWORD_STORE
...
OPTIONAL_ENV_VARS = {
    ...
    "MATRIX_DEVICE_ID": {
        "description": "Stable Matrix device ID for E2EE persistence across restarts (e.g. THEFOOL_BOT)",
    ...
    # THEFOOL_TOOL_PROGRESS_MODE is deprecated — tool progress is configured via
    # display.tool_progress in config.yaml (off|new|all|verbose|log). The
    # gateway still falls back to THEFOOL_TOOL_PROGRESS_MODE for backward
