...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateHermes: "Aggiorna The Fool",
    updatingHermes: "Aggiornamento di The Fool…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin The Fool (parità con `fool plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.fool/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.fool/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.fool/skills/",
  ...
  env: {
    ...
    customHint: "Variabili d'ambiente arbitrarie salvate nel tuo .env che The Fool non riconosce. Usale per iniettare variabili d'ambiente per skill, server MCP o i tuoi strumenti.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge The Fool da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni The Fool in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa The Fool di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando The Fool rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "The Fool sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
