...
export interface PetInfo {
  ...
  // the Fool "run" activity state uses the in-place running row).
 ...
 * FOOL_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'fool.desktop.pet-roam.v1'
