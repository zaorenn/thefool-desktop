...
* This module intentionally mirrors ``thefool_cli/goals.py`` — same aux
...
THEFOOL_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("THEFOOL_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)
...
def _profile_author() -> str:
    """Mirror of ``thefool_cli.kanban._profile_author``. Kept local to
    avoid a circular import when kanban.py imports this module."""
    return (
        os.environ.get("THEFOOL_PROFILE")
    ...
    *,
    ...
    try:
        ...
        resp = call_llm(
            ...
            temperature=0.3,
            max_tokens=THEFOOL_KANBAN_SPECIFY_MAX_TOKENS,
