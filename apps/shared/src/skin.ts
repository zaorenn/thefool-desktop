 ...
 *
 * A skin is authored once as YAML in `$THEFOOL_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`thefool_cli/skin_engine.py`),
 ...
 *   • CLI     → `thefool_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
