...
from fool_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
...
def _auto_sso_response(request: Request) -> Response | None:
    ...
    from fool_cli.dashboard_auth.cookies import detect_https
    set_sso_attempt_cookie(
...
async def gated_auth_middleware(
    ...
    if session is None:
        ...
        from fool_cli.dashboard_auth.cookies import clear_session_cookies
        from fool_cli.dashboard_auth.prefix import prefix_from_request
