...
from thefool_cli.setup_hidden_env import is_setup_hidden_env
...
class TestChannelCards:
    def test_discord_card_asks_for_token_and_allowlist_only(self):
        ...
        from thefool_cli.web_server import _build_catalog_entry
    ...
    def test_no_card_shows_a_hidden_knob(self):
        from thefool_cli.web_server import _messaging_platform_catalog
    ...
    def test_hidden_knobs_move_to_the_keys_page_not_into_a_void(self):
        ...
        from thefool_cli.web_server import _channel_managed_env_keys
...
class TestCliWizard:
    ...
    stdin, real .env writes under a temp THEFOOL_HOME."""
