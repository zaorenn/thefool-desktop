...
from cli import FoolCLI, _rich_text_from_ansi
from fool_cli.skin_engine import get_active_skin, set_active_skin
...
class TestCliSkinPromptIntegration:
    ...
    def test_narrow_terminals_compact_voice_recording_prompt_fragments(self):
        ...
        with patch.object(FoolCLI, "_get_tui_terminal_width", return_value=50):
