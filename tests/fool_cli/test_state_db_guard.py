...
from fool_cli.backup import copy_db_and_verify, verify_sqlite_integrity
...
class TestPreUpdateBackupIntegrityGuard:
    ...
    FOOL_HOME whose state.db is corrupted mid-flight (#68474)."""
    ...
    def hermes_home(self, tmp_path, monkeypatch):
        ...
        for mod in list(sys.modules.keys()):
            if mod.startswith("fool_cli.config") or mod == "fool_constants":
                del sys.modules[mod]
        return root
