"""Unit tests for ``thefool_cli.proxy_cli`` command handlers.
...
from thefool_cli import proxy_cli


@pytest.fixture
def hermes_home(tmp_path, monkeypatch):
    """Point THEFOOL_HOME at a temp dir so the wizard doesn't touch the
...
def test_cmd_disable_uses_public_status_pid_not_private_read_pid(
    ...
    # mutation only.
    from thefool_cli.config import load_config as _lc
    cfg2 = _lc()
