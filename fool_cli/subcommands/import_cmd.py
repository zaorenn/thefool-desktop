...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a Fool backup from a zip file",
        description="Extract a previously created The Fool backup into your "
        "The Fool home directory, restoring configuration, skills, "
        "sessions, and data",
    )
