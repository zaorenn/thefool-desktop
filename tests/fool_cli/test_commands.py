...
class TestSlackAppManifest:
    """Generated Slack app manifest (used by `fool slack manifest`)."""
...
class TestSubcommandCompletion:
    ...
    def test_tools_enable_skips_already_listed(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "fool_cli.tools_config._get_plugin_toolset_keys",
            lambda: set(),
        )
...
from fool_cli.commands import discord_skill_commands_by_category  # noqa: E402
...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch fool_cli.plugins.get_plugin_commands() to a fixed dict."""
