...
from fool_cli.observability.shared_metrics_contract import MODEL_ROUTE_METRIC
from fool_cli.observability.shared_metrics_subscriber import SharedMetricsSubscriber


@pytest.fixture()
def relay_turn(tmp_path, monkeypatch):
    monkeypatch.setenv("FOOL_HOME", str(tmp_path / "profile"))
