...
from thefool_constants import get_hermes_home, get_optional_mcps_dir
...
from thefool_cli.cli_output import prompt as _prompt_input
...
def _build_server_config(
    ...
    if t.type == "stdio":
        ...
        if entry.auth.type == "oauth":
            ...
            from thefool_cli.mcp_config import _bearer_auth_headers
...
def _probe_tools(name: str) -> Optional[List[tuple]]:
    ...
    try:
        ...
        from thefool_cli.mcp_config import _probe_single_server
...
def install_entry(entry: CatalogEntry, *, enable: bool = True) -> None:
    ...
    from thefool_cli.mcp_config import _save_mcp_server
