"""Tests for provider-aware `/model` validation in fool_cli.models."""
...
def _validate(model, provider="openrouter", api_models=FAKE_API_MODELS, **kw):
    ...
    with patch("fool_cli.models.fetch_api_models", return_value=api_models), \
...
class TestProviderModelIds:
    ...
    def test_anthropic_provider_uses_configured_base_url_for_live_catalog(self):
        ...
        with patch(
            ...
            "fool_cli.models._urlopen_model_catalog_request",
            return_value=_Resp(),
        ) as mock_urlopen:
...
class TestFetchApiModels:
    ...
    def test_probe_api_models_tries_v1_fallback(self):
        ...
        with patch("fool_cli.models._urlopen_model_catalog_request", side_effect=_fake_urlopen):
    ...
    def test_probe_api_models_uses_copilot_catalog(self):
        ...
        with patch("fool_cli.models._urlopen_model_catalog_request", return_value=_Resp()) as mock_urlopen:
...
class TestValidateApiFallback:
    ...
    def test_fetch_lmstudio_models_filters_embedding_type(self):
        ...
        with patch("fool_cli.models._urlopen_model_catalog_request", return_value=mock_resp):
    ...
    def test_validate_lmstudio_distinguishes_auth_failure(self):
        ...
        with patch("fool_cli.models._urlopen_model_catalog_request", side_effect=http_error):
...
class TestValidateCodexAutoCorrection:
    ...
    def test_missing_dash_auto_corrects(self):
        ...
        with patch("fool_cli.models.provider_model_ids", return_value=codex_models):
