...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        # originate from untrusted input (X-Fool-Session-Id header), and an
        ...
        if env_var_enabled("FOOL_DUMP_REQUEST_STDOUT"):
...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    if eff_provider.strip().lower() == "moa":
        try:
            from fool_cli.config import load_config as _load_moa_cfg
    ...
    if is_anthropic_wire or _litellm_openai_wire:
        try:
            from fool_cli.config import get_custom_provider_model_capability
...
def switch_model(agent, new_model, new_provider, api_key='', base_url='', api_mode=''):
    ...
    try:
        ...
        from fool_cli.config import load_config as _sm_load_config
...
def invoke_tool(agent, function_name: str, function_args: dict, effective_task_id: str,
    ...
    try:
        from fool_cli.middleware import apply_tool_request_middleware
    ...
    from fool_cli.middleware import run_tool_execution_middleware
