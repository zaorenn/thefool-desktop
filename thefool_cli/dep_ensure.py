...
from thefool_constants import agent_browser_runnable, find_node_executable
from tools.environments.local import hermes_subprocess_env

_IS_WINDOWS = platform.system() == "Windows"

_DEP_CHECKS = {
    # find_node_executable() rather than a bare which(): $THEFOOL_HOME/node is
...
def _has_hermes_agent_browser() -> bool:
    ...
    # install.sh installs globally into $THEFOOL_HOME/node/bin/ via npm -g --prefix
