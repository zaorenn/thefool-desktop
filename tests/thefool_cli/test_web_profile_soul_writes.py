...
def client(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("THEFOOL_DASHBOARD_SESSION_TOKEN", "soul-test-token")
...
def profile_dir(tmp_path, monkeypatch) -> Path:
    """Create a real profile directory under the test THEFOOL_HOME."""
    monkeypatch.setenv("THEFOOL_HOME", str(tmp_path))
...
class TestSoulWriteDurability:
    ...
    def test_existing_soul_survives_an_interrupted_save(
        ...
        # THEFOOL_HOME patch the client/profile_dir fixtures installed.
