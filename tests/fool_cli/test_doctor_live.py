...
from fool_cli import doctor_live
from fool_cli.doctor_live import (
    ProbeResult,
...
class TestBrowserAvailableNpxRung:
    ...
    def _block_path_and_node_modules_checks(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("fool_cli.doctor.FOOL_HOME", tmp_path / "home")
        monkeypatch.setattr("fool_cli.doctor.PROJECT_ROOT", tmp_path / "root")
