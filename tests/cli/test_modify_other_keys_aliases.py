...
from fool_cli.pt_input_extras import install_modify_other_keys_aliases
...
def test_does_not_clobber_shift_enter_alias():
    ...
    from fool_cli.pt_input_extras import install_shift_enter_alias
...
def test_does_not_clobber_ctrl_enter_alias():
    ...
    from fool_cli.pt_input_extras import install_ctrl_enter_alias
...
def test_cmd_backspace_alias_not_clobbered():
    ...
    from fool_cli.pt_input_extras import install_cmd_backspace_alias
