"""Tests for fool_cli.relaunch — unified self-relaunch utility."""

import sys

import pytest

from fool_cli import relaunch as relaunch_mod


class TestResolveFoolBin:
...
class TestResolveFoolBinWindowsPyGuard:
