"""Unit tests for thefool_cli.pty_bridge — PTY spawning + byte forwarding.
...
class TestClampDimension:
    def test_clamps_above_max(self):
        from thefool_cli.pty_bridge import _MAX_COLS, _MAX_ROWS, _clamp_dimension
    ...
    def test_non_numeric_falls_back_to_min(self):
        from thefool_cli.pty_bridge import _MAX_COLS, _clamp_dimension
