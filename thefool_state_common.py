...
Extracted verbatim from thefool_state.py so the SessionDB mixin modules
(thefool_state_search / thefool_state_schema / thefool_state_portability) can
reference them without importing thefool_state (which would be a cycle).
thefool_state re-imports every name here for backward compatibility.
"""
