"""Tests for `fool secrets bitwarden token` / `fool secrets onepassword token`.
...
from fool_cli import onepassword_secrets_cli as op_cli
from fool_cli import secrets_cli as bw_cli
