...
def test_run_xai_oauth_login_from_setup_does_not_hijack_active_provider(
    ...
    monkeypatch.setattr("thefool_cli.auth._is_remote_session", lambda: True)

    from thefool_cli.auth import is_source_suppressed, suppress_credential_source
    from thefool_cli.setup import _run_xai_oauth_login_from_setup
