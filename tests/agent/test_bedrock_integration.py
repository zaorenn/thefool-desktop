...
Note: Tests that import ``thefool_cli.auth`` or ``thefool_cli.runtime_provider``
...
class TestProviderAliases:
    ...
    def test_aws_alias(self):
        from thefool_cli.models import _PROVIDER_ALIASES
...
class TestProviderLabels:
    ...
    def test_bedrock_label(self):
        from thefool_cli.models import _PROVIDER_LABELS
...
class TestResolveProvider:
    ...
    def test_auto_detect_with_aws_credentials(self, monkeypatch):
        ...
        with patch("thefool_cli.auth._load_auth_store", return_value={}):
...
class TestRuntimeProvider:
    ...
    def test_bedrock_runtime_no_credentials_raises_on_auto_detect(self, monkeypatch):
        ...
        with patch("thefool_cli.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("thefool_cli.runtime_provider._get_model_config", return_value={"provider": "bedrock"}), \
             patch("thefool_cli.runtime_provider.resolve_requested_provider", return_value="auto"), \
...
class TestProvidersModule:
    """Verify bedrock is wired into thefool_cli/providers.py."""

    def test_bedrock_alias_in_providers(self):
        from thefool_cli.providers import ALIASES
