...
_SYNC_TRACE_ENV = "FOOL_OPENVIKING_SYNC_TRACE"
...
def _openviking_server_log_path() -> Path:
    try:
        ...
        home = Path(os.environ.get("FOOL_HOME", "")).expanduser() if os.environ.get("FOOL_HOME") else Path.home() / ".hermes"
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        from fool_cli.memory_setup import _CANCELLED, _curses_select, _print_cancelled_setup, _prompt
