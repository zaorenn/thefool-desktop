...
#
# Kendi toplama ucunu kurmak istersen THEFOOL_DIAGNOSTICS_BASE_URL ile
# isaretleyebilirsin; akis oldugu gibi calisir.
NAS_BASE = os.environ.get("THEFOOL_DIAGNOSTICS_BASE_URL", "")
...
def request_upload_url(
    ...
    if not NAS_BASE:
        raise RuntimeError(
            ...
            "uploading, set THEFOOL_DIAGNOSTICS_BASE_URL to an endpoint you control."
        )
