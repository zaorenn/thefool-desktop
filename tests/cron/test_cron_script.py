...
- Path resolution (absolute, relative to FOOL_HOME/scripts/)
"""
...
def cron_env(tmp_path, monkeypatch):
    """Isolated cron environment with temp FOOL_HOME."""
...
class TestRunJobEnvVarCleanup:
    ...
    def test_env_vars_cleaned_on_early_error(self, cron_env, monkeypatch):
        ...
        assert os.environ.get("FOOL_SESSION_PLATFORM") is None
        assert os.environ.get("FOOL_SESSION_CHAT_ID") is None
        assert os.environ.get("FOOL_SESSION_CHAT_NAME") is None
