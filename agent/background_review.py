...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Hub-installed skills (installed via 'fool skills install').\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked via 'fool curator pin'). You are an "
    ...
    "'fool curator adopt <name>' — do not try to patch it.\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "  • Hub-installed skills (installed via 'fool skills install').\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked via 'fool curator pin'). Pin blocks "
    ...
    "reply and recommend 'fool curator adopt <name>' instead.\n"
    "If the only skills that need updating are protected, say\n"
    "'Nothing to save.' and stop.\n\n"
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("FOOL_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:
