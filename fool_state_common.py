...
Extracted verbatim from fool_state.py so the SessionDB mixin modules
(fool_state_search / fool_state_schema / fool_state_portability) can
reference them without importing fool_state (which would be a cycle).
fool_state re-imports every name here for backward compatibility.
"""
