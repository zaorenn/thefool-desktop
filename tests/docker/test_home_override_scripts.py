...
def test_dashboard_service_resets_home(
    ...
    container with THEFOOL_DASHBOARD=1 and verify the dashboard process
    ...
    the process env.
    """
    start_container(built_image, container_name, "THEFOOL_DASHBOARD=1", "THEFOOL_DASHBOARD_HOST=127.0.0.1")
...
def test_dashboard_does_not_auto_insecure_from_host(
    ...
    THEFOOL_DASHBOARD_HOST. The auth gate is the authority now.
    ...
    """
    start_container(built_image, container_name, "THEFOOL_DASHBOARD=1", "THEFOOL_DASHBOARD_HOST=0.0.0.0")
