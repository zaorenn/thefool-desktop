...
| | |
|---|---|
| Source | Optional — install with `fool skills install official/software-development/rest-graphql-debug` |
...
- Never hardcode tokens in scripts. Read from env (`os.environ["API_TOKEN"]`) or `${FOOL_HOME:-~/.hermes}/.env`.
