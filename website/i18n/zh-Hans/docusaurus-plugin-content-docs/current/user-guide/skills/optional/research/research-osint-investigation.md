...
| | |
|---|---|
| 来源 | 可选 — 通过 `fool skills install official/research/osint-investigation` 安装 |
...
# 之后在本地搜索。缓存 30 天，存储于
# $FOOL_OSINT_CACHE/icij/（默认：~/.cache/hermes-osint/icij/）。
...
# 设置 FOOL_OSINT_UA=your-app/1.0 (your@email) 以标识自身
