...
class TestGenericProviderLiveCuratedMerge:
    ...
    def test_curated_first_for_single_provider(self):
        ...
        with (
            ...
            patch.dict("thefool_cli.models._PROVIDER_MODELS", {"zai": curated}),
        ):
    ...
    def test_no_models_dropped_either_direction(self):
        ...
        with (
            ...
            patch.dict("thefool_cli.models._PROVIDER_MODELS", {"zai": ["c", "b"]}),
        ):
        ...
        with (
            ...
            patch.dict("thefool_cli.models._PROVIDER_MODELS", {"opencode-zen": ["c", "b"]}),
        ):
