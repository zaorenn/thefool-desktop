...
from thefool_cli.dashboard_auth.base import ProviderError, RefreshExpiredError
...
class TestTransparentRefreshOnAccessTokenEviction:
    ...
    def _build_rt_only_app(self):
        ...
        """
        import time as _t
        from tests.thefool_cli.conftest_dashboard_auth import _sign
...
class TestAutoSsoRedirect:
    ...
    from thefool_cli.dashboard_auth.cookies import SSO_ATTEMPT_COOKIE
...
class TestNextSameOriginValidation:
    ...
    def test_safe_next_validator_accepts_same_origin(self):
        from thefool_cli.dashboard_auth.middleware import _safe_next_target
...
class TestValidatePostLoginTarget:
    ...
    def test_accepts_same_origin_paths(self):
        from thefool_cli.dashboard_auth.routes import _validate_post_login_target
