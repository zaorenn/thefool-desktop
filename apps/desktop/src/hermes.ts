import { JsonRpcGatewayClient } from '@fool/shared'
...
export class FoolGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
...
// the call; each pooled backend already has its own FOOL_HOME, so no backend
...
async function activeConnection(): Promise<FoolConnection> {
  ...
  return window.foolDesktop.getConnection(_apiProfile)
}

/** Options for a plugin REST call — mirrors the app's own `foolDesktop.api`
 *  shape, minus the path (which is namespace-derived). */
export interface PluginRestOptions {
  method?: string
  body?: unknown
  /** Single-file multipart upload (see FoolApiRequest.upload). */
...
export async function listSessions(
  ...
  const result = await window.foolDesktop.api<PaginatedSessions>({
    path:
...
export async function listSidebarSessions(req: SidebarSessionsRequest): Promise<SidebarSessionsResponse> {
  ...
  try {
    result = await window.foolDesktop.api<SidebarSessionsResponse>({
...
export function setSessionArchived(id: string, archived: boolean, profile?: string | null): Promise<{ ok: boolean }> {
  return window.foolDesktop.api<{ ok: boolean }>({
    ...(profile ? { profile } : {}),
...
export function searchSessions(query: string): Promise<SessionSearchResponse> {
  return window.foolDesktop.api<SessionSearchResponse>({
...
export function getSession(id: string, profile?: string | null): Promise<SessionInfo> {
  ...
  return window.foolDesktop.api<SessionInfo>({
    ...(profile ? { profile } : {}),
...
export function getSessionMessages(
  ...
  return window.foolDesktop.api<SessionMessagesResponse>({
    ...(profile ? { profile } : {}),
...
export function renameSession(
  ...
  return window.foolDesktop.api<{ ok: boolean; title: string }>({
    ...(profile ? { profile } : {}),
    path: `/api/sessions/${encodeURIComponent(id)}`,
    method: 'PATCH',
...
export function getGlobalModelInfo(): Promise<ModelInfoResponse> {
  return window.foolDesktop.api<ModelInfoResponse>({
    ...profileScoped(),
    path: '/api/model/info',
...
export function getStatus(): Promise<StatusResponse> {
  return window.foolDesktop.api<StatusResponse>({
    ...profileScoped(),
    path: '/api/status'
  })
}
...
export function getLogs(params: {
  ...
  return window.foolDesktop.api<LogsResponse>({
    ...profileScoped(),
    path: suffix ? `/api/logs?${suffix}` : '/api/logs'
  })
}

export function getFoolConfig(profile?: string): Promise<FoolConfig> {
  return window.foolDesktop.api<FoolConfig>({
...
export function getFoolConfigRecord(profile?: null | string): Promise<FoolConfigRecord> {
  return window.foolDesktop.api<FoolConfigRecord>({
    ...profileScoped(profile),
    path: '/api/config'
  })
}

export function getFoolConfigDefaults(): Promise<FoolConfigRecord> {
  return window.foolDesktop.api<FoolConfigRecord>({
    ...profileScoped(),
...
export function getFoolConfigSchema(): Promise<ConfigSchemaResponse> {
  return window.foolDesktop.api<ConfigSchemaResponse>({
    ...profileScoped(),
    path: '/api/config/schema'
  })
}

export function saveFoolConfig(config: FoolConfigRecord): Promise<{ ok: boolean }> {
  return window.foolDesktop.api<{ ok: boolean }>({
    ...profileScoped(),
    path: '/api/config',
    method: 'PUT',
...
export function getMemoryProviderConfig(provider: string): Promise<MemoryProviderConfig> {
  return window.foolDesktop.api<MemoryProviderConfig>({
    ...profileScoped(),
...
export function getEnvVars(): Promise<Record<string, EnvVarInfo>> {
  return window.foolDesktop.api<Record<string, EnvVarInfo>>({
    ...profileScoped(),
    path: '/api/env'
  })
}
...
export function validateProviderCredential(
  ...
  return window.foolDesktop.api<{ ok: boolean; reachable: boolean; message: string; models?: string[] }>({
    ...profileScoped(),
...
export function getCustomEndpoints(): Promise<CustomEndpointsResponse> {
  return window.foolDesktop.api<CustomEndpointsResponse>({
    ...profileScoped(),
...
export function validateCustomEndpoint(endpoint: CustomEndpointUpdate): Promise<CustomEndpointValidationResponse> {
  return window.foolDesktop.api<CustomEndpointValidationResponse>({
...
export function activateCustomEndpoint(id: string): Promise<{ ok: boolean; provider: string; model: string }> {
  return window.foolDesktop.api<{ ok: boolean; provider: string; model: string }>({
    ...profileScoped(),
...
export function revealEnvVar(key: string, profile?: null | string): Promise<{ key: string; value: string }> {
  return window.foolDesktop.api<{ key: string; value: string }>({
    ...profileScoped(profile),
    path: '/api/env/reveal',
    method: 'POST',
    body: { key }
...
export function listOAuthProviders(): Promise<OAuthProvidersResponse> {
  return window.foolDesktop.api<OAuthProvidersResponse>({
    ...profileScoped(),
...
export function disconnectOAuthProvider(providerId: string): Promise<{ ok: boolean; provider: string }> {
  return window.foolDesktop.api<{ ok: boolean; provider: string }>({
    ...profileScoped(),
...
export function startOAuthLogin(providerId: string, profile?: null | string): Promise<OAuthStartResponse> {
  return window.foolDesktop.api<OAuthStartResponse>({
    ...profileScoped(profile),
...
export function submitOAuthCode(providerId: string, sessionId: string, code: string): Promise<OAuthSubmitResponse> {
  return window.foolDesktop.api<OAuthSubmitResponse>({
    ...profileScoped(),
...
export function pollOAuthSession(
  ...
  return window.foolDesktop.api<OAuthPollResponse>({
    ...profileScoped(profile),
...
export function startMemoryProviderOAuth(provider: string): Promise<MemoryProviderOAuthStatus> {
  return window.foolDesktop.api<MemoryProviderOAuthStatus>({
    ...profileScoped(),
...
export function getSkills(profile?: null | string): Promise<SkillInfo[]> {
  return window.foolDesktop.api<SkillInfo[]>({
    ...profileScoped(profile),
    path: '/api/skills'
  })
}
...
export function getSkillContent(
  ...
  return window.foolDesktop.api<{ content: string; name: string; path: string }>({
    ...profileScoped(profile),
...
export function getStarmapGraph(): Promise<StarmapGraph> {
  return window.foolDesktop.api<StarmapGraph>({
    ...profileScoped(),
...
export function getLearningNode(id: string, profile?: null | string): Promise<LearningNodeDetail> {
  return window.foolDesktop.api<LearningNodeDetail>({
    ...profileScoped(profile),
...
export function deleteLearningNode(id: string, profile?: null | string): Promise<{ message: string; ok: boolean }> {
  return window.foolDesktop.api<{ message: string; ok: boolean }>({
    ...profileScoped(profile),
...
export function setSkillEnabled(
  ...
  return window.foolDesktop.api<{ ok: boolean; name: string; enabled: boolean }>({
    ...profileScoped(profile),
...
export function testMcpServer(name: string, profile?: null | string): Promise<McpTestResult> {
  return window.foolDesktop.api<McpTestResult>({
    ...profileScoped(profile),
 ...
 *  `saveFoolConfig`, this REPLACES rather than deep-merges, so deletes,
...
export function authMcpServer(name: string, profile?: null | string): Promise<McpOAuthFlow> {
  return window.foolDesktop.api<McpOAuthFlow>({
    ...profileScoped(profile),
...
export function cancelMcpOAuthFlow(flowId: string, profile?: null | string): Promise<{ ok: boolean; status: string }> {
  return window.foolDesktop.api<{ ok: boolean; status: string }>({
    ...profileScoped(profile),
    path: `/api/mcp/oauth/flows/${encodeURIComponent(flowId)}`,
    method: 'DELETE'
  })
...
export function getToolsets(profile?: null | string): Promise<ToolsetInfo[]> {
  return window.foolDesktop.api<ToolsetInfo[]>({
    ...profileScoped(profile),
...
export function getToolsetConfig(name: string, profile?: null | string): Promise<ToolsetConfig> {
  return window.foolDesktop.api<ToolsetConfig>({
    ...profileScoped(profile),
...
export function getToolsetModels(
  ...
  return window.foolDesktop.api<ToolsetModelsResponse>({
    ...profileScoped(profile),
...
export function selectToolsetModel(
  ...
  return window.foolDesktop.api<{ ok: boolean; name: string; model: string }>({
    ...profileScoped(profile),
...
export function selectToolsetProvider(
  ...
  return window.foolDesktop.api<SelectToolsetProviderResponse>({
    ...profileScoped(profile),
...
export function runToolsetPostSetup(
  ...
  return window.foolDesktop.api<ActionResponse & { key: string }>({
    ...profileScoped(profile),
...
export function getTerminalBackends(): Promise<TerminalBackendsResponse> {
  return window.foolDesktop.api<TerminalBackendsResponse>({
    ...profileScoped(),
...
export function selectTerminalBackend(backend: string): Promise<{ ok: boolean; backend: string }> {
  return window.foolDesktop.api<{ ok: boolean; backend: string }>({
    ...profileScoped(),
...
export function getComputerUseStatus(): Promise<ComputerUseStatus> {
  return window.foolDesktop.api<ComputerUseStatus>({
    ...profileScoped(),
...
export function grantComputerUsePermissions(): Promise<ActionResponse> {
  return window.foolDesktop.api<ActionResponse>({
    ...profileScoped(),
...
export function getMessagingPlatforms(): Promise<MessagingPlatformsResponse> {
  return window.foolDesktop.api<MessagingPlatformsResponse>({
...
export function updateMessagingPlatform(
  ...
  return window.foolDesktop.api<{ ok: boolean; platform: string }>({
...
export function testMessagingPlatform(platformId: string): Promise<MessagingPlatformTestResponse> {
  return window.foolDesktop.api<MessagingPlatformTestResponse>({
...
export function getPairing(): Promise<PairingResponse> {
  return window.foolDesktop.api<PairingResponse>({
    ...profileScoped(),
    path: '/api/pairing'
  })
}
...
export function approvePairing(platform: string, requestId: string): Promise<{ ok: boolean; user: PairingUser }> {
  return window.foolDesktop.api<{ ok: boolean; user: PairingUser }>({
    ...profileScoped(),
...
export function getWebhooks(): Promise<WebhooksResponse> {
  return window.foolDesktop.api<WebhooksResponse>({
    ...profileScoped(),
    path: '/api/webhooks'
  })
}
...
export function enableWebhooks(): Promise<WebhookEnableResponse> {
  return window.foolDesktop.api<WebhookEnableResponse>({
    ...profileScoped(),
...
export function createWebhook(body: WebhookCreatePayload): Promise<WebhookCreateResponse> {
  return window.foolDesktop.api<WebhookCreateResponse>({
    ...profileScoped(),
    path: '/api/webhooks',
    method: 'POST',
    body
...
export function setWebhookEnabled(
  ...
  return window.foolDesktop.api<{ enabled: boolean; name: string; ok: boolean }>({
    ...profileScoped(),
...
// Cron jobs are stored per-profile (<FOOL_HOME>/cron/jobs.json), and the
...
export function getCronJobs(profile?: string): Promise<CronJob[]> {
  ...
  return window.foolDesktop.api<CronJob[]>({
    ...profileScoped(),
    ...connectionScoped(),
...
export async function getCronJobRuns(jobId: string, limit = 20): Promise<SessionInfo[]> {
  const { runs } = await window.foolDesktop.api<{ runs: SessionInfo[] }>({
    ...profileScoped(),
    ...connectionScoped(),
...
export async function getCronDeliveryTargets(): Promise<CronDeliveryTarget[]> {
  const { targets } = await window.foolDesktop.api<{ targets: CronDeliveryTarget[] }>({
    ...profileScoped(),
    ...connectionScoped(),
...
export function getAutomationBlueprints(): Promise<{ blueprints: AutomationBlueprint[] }> {
  return window.foolDesktop.api<{ blueprints: AutomationBlueprint[] }>({
    ...profileScoped(),
    ...connectionScoped(),
...
export function getProfiles(): Promise<ProfilesResponse> {
  return window.foolDesktop.api<ProfilesResponse>({
    path: '/api/profiles',
    timeoutMs: STARTUP_REQUEST_TIMEOUT_MS
  })
}
...
export function createProfile(body: ProfileCreatePayload): Promise<{ name: string; ok: boolean; path: string }> {
  return window.foolDesktop.api<{ name: string; ok: boolean; path: string }>({
    path: '/api/profiles',
    method: 'POST',
    body
  })
...
export function deleteProfile(name: string): Promise<{ ok: boolean; path: string }> {
  return window.foolDesktop.api<{ ok: boolean; path: string }>({
    path: `/api/profiles/${encodeURIComponent(name)}`,
    method: 'DELETE'
  })
}
...
export function getProfileSoul(name: string): Promise<ProfileSoul> {
  return window.foolDesktop.api<ProfileSoul>({
...
export function getProfileSetupCommand(name: string): Promise<ProfileSetupCommand> {
  return window.foolDesktop.api<ProfileSetupCommand>({
...
export function exportProfileArchive(
  ...
  return window.foolDesktop.api<{ archive: string; ok: boolean }>({
...
export function importProfileArchive(
  ...
  return window.foolDesktop.api<{ desktop: null | ProfileDesktopOverlay; name: string; ok: boolean; path: string }>({
...
export function getUsageAnalytics(days = 30, profile?: null | string): Promise<AnalyticsResponse> {
  return window.foolDesktop.api<AnalyticsResponse>({
    ...profileScoped(profile),
...
export function getGlobalModelOptions(opts?: {
  ...
  return window.foolDesktop.api<ModelOptionsResponse>({
    ...profileScoped(),
...
// curation `fool model` does — for Nous it honors the free/paid tier so a
// free user gets a free model instead of a paid default.
export function getRecommendedDefaultModel(provider: string): Promise<RecommendedDefaultModel> {
  return window.foolDesktop.api<RecommendedDefaultModel>({
    ...profileScoped(),
...
export function getAuxiliaryModels(): Promise<AuxiliaryModelsResponse> {
  return window.foolDesktop.api<AuxiliaryModelsResponse>({
    ...profileScoped(),
...
export function getMoaModels(): Promise<MoaConfigResponse> {
  return window.foolDesktop.api<MoaConfigResponse>({
    ...profileScoped(),
    path: '/api/model/moa'
  })
}
...
export function saveMoaModels(body: MoaConfigResponse): Promise<MoaConfigResponse & { ok: boolean }> {
  return window.foolDesktop.api<MoaConfigResponse & { ok: boolean }>({
    ...profileScoped(),
    path: '/api/model/moa',
    method: 'PUT',
    body
...
export function setModelAssignment(body: ModelAssignmentRequest): Promise<ModelAssignmentResponse> {
  return window.foolDesktop.api<ModelAssignmentResponse>({
    ...profileScoped(),
    path: '/api/model/set',
    method: 'POST',
    body
...
export function updateFool(): Promise<ActionResponse> {
  return window.foolDesktop.api<ActionResponse>({
    ...profileScoped(),
...
export function checkFoolUpdate(force = false): Promise<BackendUpdateCheckResponse> {
  return window.foolDesktop.api<BackendUpdateCheckResponse>({
    ...profileScoped(),
...
export function getActionStatus(name: string, lines = 200, profile?: null | string): Promise<ActionStatusResponse> {
  return window.foolDesktop.api<ActionStatusResponse>({
    ...profileScoped(profile),
...
export function transcribeAudio(dataUrl: string, mimeType?: string): Promise<AudioTranscriptionResponse> {
  return window.foolDesktop.api<AudioTranscriptionResponse>({
...
export function speakText(text: string): Promise<AudioSpeakResponse> {
  return window.foolDesktop.api<AudioSpeakResponse>({
    ...profileScoped(),
...
export function getElevenLabsVoices(): Promise<ElevenLabsVoicesResponse> {
  return window.foolDesktop.api<ElevenLabsVoicesResponse>({
...
// ---------------------------------------------------------------------------
// Skills hub — search / preview / scan / install (parity with `fool skills`
...
export function getSkillHubSources(profile?: null | string): Promise<SkillHubSourcesResponse> {
  return window.foolDesktop.api<SkillHubSourcesResponse>({
    ...profileScoped(profile),
...
export function searchSkillsHub(
  ...
  return window.foolDesktop.api<SkillHubSearchResponse>({
    ...profileScoped(profile),
...
export function previewSkillHub(identifier: string, profile?: null | string): Promise<SkillHubPreview> {
  return window.foolDesktop.api<SkillHubPreview>({
    ...profileScoped(profile),
...
export function scanSkillHub(identifier: string, profile?: null | string): Promise<SkillHubScanResult> {
  return window.foolDesktop.api<SkillHubScanResult>({
    ...profileScoped(profile),
...
// `fool mcp` and the dashboard MCP page). Raw JSON editing stays in
// config.yaml via saveFoolConfig.
// ---------------------------------------------------------------------------

export function listMcpServers(): Promise<{ servers: McpServerSummary[] }> {
  return window.foolDesktop.api<{ servers: McpServerSummary[] }>({
    ...profileScoped(),
    path: '/api/mcp/servers'
  })
}
...
export function addMcpServer(body: {
  ...
  return window.foolDesktop.api<McpServerSummary>({
    ...profileScoped(),
    path: '/api/mcp/servers',
    method: 'POST',
    body
...
export function getMcpCatalog(profile?: null | string): Promise<McpCatalogResponse> {
  return window.foolDesktop.api<McpCatalogResponse>({
    ...profileScoped(profile),
...
export function getGhAuthStatus(refresh = false): Promise<{ available: boolean; authenticated: boolean }> {
  return window.foolDesktop.api<{ available: boolean; authenticated: boolean }>({
    ...profileScoped(),
...
export function installMcpCatalogEntry(
  ...
  return window.foolDesktop.api<{ ok: boolean; name?: string; pid?: number; action?: string; background?: boolean }>({
    ...profileScoped(profile),
...
// ---------------------------------------------------------------------------
// Memory data + curator (parity with `fool memory` / `fool curator`).
// ---------------------------------------------------------------------------

export function getMemoryStatus(): Promise<MemoryStatusResponse> {
  return window.foolDesktop.api<MemoryStatusResponse>({
    ...profileScoped(),
    path: '/api/memory'
  })
}
...
export function resetMemory(target: 'all' | 'memory' | 'user'): Promise<{ ok: boolean; deleted: string[] }> {
  return window.foolDesktop.api<{ ok: boolean; deleted: string[] }>({
    ...profileScoped(),
...
export function getCuratorStatus(): Promise<CuratorStatusResponse> {
  return window.foolDesktop.api<CuratorStatusResponse>({
    ...profileScoped(),
    path: '/api/curator'
  })
}
...
export function setCuratorPaused(paused: boolean): Promise<{ ok: boolean; paused: boolean }> {
  return window.foolDesktop.api<{ ok: boolean; paused: boolean }>({
    ...profileScoped(),
...
// ---------------------------------------------------------------------------
// Maintenance operations (parity with `fool doctor` / `hermes security
// audit` / `fool backup` / `fool debug share` and the dashboard System
...
export function runDoctor(): Promise<ActionResponse> {
  return window.foolDesktop.api<ActionResponse>({ path: '/api/ops/doctor', method: 'POST', body: {} })
}

export function runSecurityAudit(): Promise<ActionResponse> {
  return window.foolDesktop.api<ActionResponse>({ path: '/api/ops/security-audit', method: 'POST', body: {} })
}

export function runBackup(): Promise<ActionResponse & { archive?: string }> {
  return window.foolDesktop.api<ActionResponse & { archive?: string }>({
    path: '/api/ops/backup',
    method: 'POST',
    body: {}
  })
...
export function runDebugShare(): Promise<DebugShareResponse> {
  return window.foolDesktop.api<DebugShareResponse>({
