...
from fool_cli.pty_session import RingBuffer
...
async def test_attach_replays_buffer_then_streams_live():
    from fool_cli.pty_session import PtySession
...
from fool_cli.pty_session import PtySessionRegistry, RegistryFull
...
async def test_reaper_loop_invokes_reap(monkeypatch):
    from fool_cli.pty_session import run_reaper
    reg = make_registry()
    calls = {"n": 0}
