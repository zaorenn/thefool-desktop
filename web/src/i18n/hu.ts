...
export const hu: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "The Fool-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `fool plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.fool/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.fool/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.fool/skills/ mappából töltődnek be",
  ...
  env: {
    ...
    customHint: "A .env fájlban tárolt tetszőleges környezeti változók, amelyeket a Fool nem ismer fel. Használd ezeket környezeti változók beillesztésére képességekhez, MCP-kiszolgálókhoz vagy saját eszközeidhez.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető The Fool-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "The Fool munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a Fool kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A Fool egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
