...
from thefool_state import FTS_STORAGE_VERSION, SCHEMA_VERSION, SessionDB
...
def test_snapshot_blocks_connections_opened_during_the_copy(
    ...
    from thefool_cli import session_recovery as recovery_module
...
def test_cli_allow_partial_salvages_rows_across_a_corrupt_leaf(
    ...
    env = os.environ.copy()
    env["THEFOOL_HOME"] = str(tmp_path / "isolated-hermes-home")
