"""Tests for the shared byte formatter (thefool_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from thefool_cli.backup import _format_size as backup
    from thefool_cli.checkpoints import _fmt_bytes as checkpoints
    from thefool_cli.doctor import _human_bytes as doctor
