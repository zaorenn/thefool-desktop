...
Reads THEFOOL_KANBAN_TASK from env, heartbeats periodically, does short
...
def main():
    tid = os.environ["THEFOOL_KANBAN_TASK"]
    workspace = os.environ.get("THEFOOL_KANBAN_WORKSPACE", "")
